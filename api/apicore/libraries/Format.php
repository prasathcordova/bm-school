...
class Format {
    ...
    protected function _from_json($data)
    {
     ...
     /**
     * @param string $data Encoded jsonp string
     * @return mixed Decoded jsonp string with leading and trailing whitespace removed
     */
    protected function _from_jsonp($data)
    {
        return json_decode(trim($data));
    }
