...
/**
 * Description of Passenger_stud_droptripchange_model
 *
 * @author chandrajith
 */
class Passenger_stud_droptripchange_model extends CI_Model{
    ...
    public function get_trip_data($dbparams) {
        ...
        if (is_array($dbparams)) {           
            ...
            $trip_details = $this->db->query("[docme_transport].[routelinktrip_select_droptripchange] ?,?,?,?", $dbparams)->result_array();
