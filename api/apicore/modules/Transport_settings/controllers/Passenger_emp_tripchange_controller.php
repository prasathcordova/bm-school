...
/**
 * Description of Passenger_emp_tripchange_controller
 *
 * @author Chandrajith
 */
class Passenger_emp_tripchange_controller extends MX_Controller{
      public function __construct() {
        parent::__construct();
        $this->load->model('Passenger_emp_tripchange_model', 'MSP');
    }
