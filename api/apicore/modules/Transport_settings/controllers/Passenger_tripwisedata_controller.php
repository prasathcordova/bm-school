...
/**
 * Description of Passenger_tripwisedata_controller
 *
 * @author Chandrajith
 */
class Passenger_tripwisedata_controller extends MX_Controller {
     public function __construct() {
        parent::__construct();
         $this->load->model('Passenger_tripwisedata_model', 'Mps');
    }
    public function get_tripwise_passnger_data($params = NULL) {       
         $dbparams = array();
...
//return $dbparams;
        $passengers_list = $this->Mps->get_tripwise_data($dbparams);
