...
/**
 * Description of Passenger_stud_droptripchange_controller
 *
 * @author Chandrajith
 */
class Passenger_stud_droptripchange_controller extends MX_Controller {
      public function __construct() {
        parent::__construct();
        $this->load->model('Passenger_stud_droptripchange_model', 'MSP');
    }
