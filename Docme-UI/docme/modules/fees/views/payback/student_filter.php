        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title" style="border-bottom-color:#ffd300 !important;">
                    <h5>Payback Request</h5>
                    <div class="ibox-tools" id="add_type">
                        <a href="javascript:void(0)" onclick="load_payback_request();" id="close_button" data-toggle="tooltip" title="Close" style="float: right; color: #B22222;"><i class="fa fa-backward"></i></a>
                    </div>
                </div>
                <div class="ibox-content">
                    <div class="row" id="admission_div">
                        <div class="col-md-12">
                            <h3 id="admission_div_h">Student Direct Search For Payback Request
                                <hr>
                            </h3>
...
<script type="text/javascript">
    ...
    function search_name() {
        ...
        var ops_url = baseurl + 'payback/search-studentname-for-payback';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function search_by_batch() {
        ...
        if (batch_id == -1) {
            ...
            var ops_url = baseurl + 'payback/advancesearch-studentname-for-payback';
            $.ajax({
                type: "POST",
                cache: false,
                async: false,
    ...
    function changed_class() {
        ...
        var ops_url = baseurl + 'payback/get-batchdetails-for-payback/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
