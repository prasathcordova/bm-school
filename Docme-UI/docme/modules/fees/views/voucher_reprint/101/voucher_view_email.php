    ...
    <div class="col-lg-12 animated fadeInRight">
        <div class="mail-box-header">
            <div class="pull-right tooltip-demo">
                ...
                <a href="javascript:" onclick="select_items(<?php echo $master_data[0]['id'] ?>,'<?php echo $master_data[0]['voucher_code'] ?>','<?php echo substr($master_data[0]['voucher_code'], 0, 3); ?>')" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Discard email"><i class="fa fa-times"></i> Discard</a>
            </div>
            <h4>
        ...
        <div class="mail-box">
            ...
            <div class="mail-text h-200">
                ...
                <div class="summernote" style="padding:1%;">
                    <?php echo $this->load->view('voucher_send_mail', TRUE); ?>
