        ...
        <div style="float:left;width: 158mm; height:120mm !important; padding-left:11mm; padding-right:11mm;background: #fff; ">
            ...
            <div style="float:left; height:33mm; width:100%; background:#fff;">
                ...
                <div style="float: left;width: 98%;padding: 1%;font-family: arial;font-size: 12px;">
                    <?php  
                    //  if(isset($pay_data[0]['trans_type']) && ($pay_data[0]['trans_type'] == trim('D') || $pay_data[0]['trans_type'] == trim('O'))) {
                    //      $typelabel = 'Ref. No.: ';
                    //      $ch_number = $pay_data[0]['payment_reference'];
                    //      $ch_date = date('d-m-Y',strtotime($pay_data[0]['payment_datetime']));
                    //  }elseif(isset($pay_data[0]['trans_type']) && $pay_data[0]['trans_type'] == trim('R')) {
                    //      $typelabel = 'Card Noaa.: ';
                    //      $ch_number = $pay_data[0]['payment_reference'];
                    //      $ch_date = date('d-m-Y',strtotime($pay_data[0]['payment_datetime']));
                    //  }else{
