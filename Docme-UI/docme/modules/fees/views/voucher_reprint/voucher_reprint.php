        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title" style="border-bottom-color:#ffd300 !important;">
                    <h5><?php echo isset($sub_title) ? $sub_title : "Voucher REPRINT" ?></h5>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-line">
                                                <div class="input-group">
                                                    <input type="text" id="searchname" name="searchname" placeholder="Enter Admission No. / Student Name" class="form-control"> <span class="input-group-btn">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="select2_registration form-control" id="voucher_type" name="voucher_type" style="width: 100%">
                                                ...
                                                ?>
                                                <option value="REGFRV">FRV - REG.FEE</option>
                                            </select>
                                        </div>
...
<script type="text/javascript">
    ...
    var inputb = document.getElementById("sname");
    ...
    function search_name() {
        ...
        if (searchname.length < 3) {
            ...
            $("#close_button").show();
            var ops_url = baseurl + 'fees/search_studentname_for_voucher_reprint';
            $.ajax({
                type: "POST",
                cache: false,
                async: false,
    ...
    function search_by_batch() {
        ...
        if (batch_id == -1) {
            ...
            $("#close_button").show();
            var ops_url = baseurl + 'fees/advancesearch_studentname_for_voucher_reprint';
            $.ajax({
                type: "POST",
                cache: false,
                async: false,
