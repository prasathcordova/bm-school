                    ...
                    <div class="ibox-content">
                        <li style="list-style: none;" class="warning-element ui-sortable-handle" id="task5">
                            ...
                            <div class="agile-detail" style="padding-top: 4px !important; text-align: center;">
                                ...
                                ?>
                                <a style="margin-top : 5px" href="javascript:void(0)" onclick="view_fee_code_with_template_student('<?php echo $template['id']; ?>', '<?php echo $template['template_name']; ?>')" class="btn btn-warning btn-sm" title="View Fee codes attached with <?php echo $template['template_name']; ?>"><i style="font-size:12px;padding-right: 5px;" class="fa fa-eye"></i> View Fee Code </a>
                                <?php if ($template['editable'] == 1) { ?>
                                    <a style="margin-top : 5px" href="javascript:void(0);" onclick="assign_students_filter('<?php echo $template['id']; ?>', '<?php echo $template['template_name']; ?>');" title="Select <?php echo $template['template_name']; ?>" class="btn btn-info btn-sm">Select <i class="fa fa-arrow-right"></i></a>
                                <?php } ?>
                                <?php
                                // }
                                ?>
