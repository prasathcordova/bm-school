                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="panel panel-info">
                                            <div class="panel-heading">
                                                ...
                                                <?php
                                                if ($backsection == 'feecode') $backfunction = 'load_fee_code_allotment()';
                                                else $backfunction = 'load_fee_student_allotment_student_wise()';
                                                ?>
                                                <span class="label label-info pull-right"><a data-toggle="tooltip" title="Close fee code allocation details" href="javascript:void(0)" onclick="<?php echo $backfunction; ?>"><i class="fa fa-close" style="font-size:15px;"></i></a></span>
                                            </div>
                                                    ...
                                                    <table class="table table-hover margin bottom" id="allotted_fee_codes">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="text-right">Fees Amount</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <?php
                                                            ...
                                                            ?>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right"><?php echo my_money_format($fee_codes['fee_amount']); ?> </td>
                                                                    </tr>
                                                            <?php
                                                                }
                                                            }
