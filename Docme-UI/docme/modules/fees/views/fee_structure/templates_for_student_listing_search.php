            ...
            <div class="col-lg-4">
                <div class="ibox float-e-margins">
                    <div id="iboxtitle_oh" class="ibox-title iboxtitle_oh" style="border-bottom-color:#23c6c8; height: 46px !important">
                        <b title="<?php echo $template['template_name']; ?>"><?php echo substr($template['template_name'], 0, 25); ?> </b>
                    </div>
                    <div class="ibox-content">
                        <li style="list-style: none;" class="warning-element ui-sortable-handle" id="task5">
                            ...
                            <div class="agile-detail" style="padding-top: 4px !important; text-align: center;">
                                ...
                                <a href="javascript:void(0);" onclick="fee_codes_link('<?php echo $template['id']; ?>', '<?php echo $template['template_name']; ?>');" title="View Students linked with template <?php echo $template['template_name']; ?>" class="btn btn-info btn-block"><i class="fa fa-eye"></i> View Students </a>
                                <?php
                                        //                                                        }
                                        ?>
                            </div>
