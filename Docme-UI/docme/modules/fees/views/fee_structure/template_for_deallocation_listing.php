            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class=" animated fadeInRight" id="template_replace">
                        <?php
                        echo $this->load->view('template_for_deallocation_listing_search');
                        ?>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    function search_template() {
        ...
        var ops_url = baseurl + 'fees/fees-student-deallocation-load-template-search/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function detach_student_list(id, name) {
    ...
    function view_fee_code_with_template(template_id, template_name) {
        var ops_url = baseurl + 'fees/view-feecode-forstudents-to-detach/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
