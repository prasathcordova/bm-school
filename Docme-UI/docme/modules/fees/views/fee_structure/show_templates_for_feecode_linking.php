            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class=" animated fadeInRight" id="template_replace">
                        <?php
                        echo $this->load->view('show_templates_for_feecode_linking_search');
                        ?>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    function search_template() {
        ...
        var ops_url = baseurl + 'fees/search_template_fee_code/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function fee_codes_link(id, name, isstl) {
        if (isstl == 1) {
            swal('', 'Student already linked with ' + name + '. Hence cannot update the fee codes to this template', 'info');
            return false;
        } else {
