                    ...
                    <div class="contact-box center-version">
                        ...
                        <div class="contact-box-footer">
                            ...
                            <div class="m-t-xs btn-group">
                                <a href="javascript:void(0);" title="Collect Fees for <?php echo $student['student_name'] ?> " onclick="collection_detail('<?php echo $student['student_id']; ?>', '<?php echo $student['student_name'] ?>')" class="btn btn-md btn-info"><i class="fa fa-user-plus"></i> Collect Fee</a>
                            </div>
                        </div>
...
<script>
    ...
    function collection_detail(studentid, studentname) {
