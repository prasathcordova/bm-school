                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12" align="">
                                ...
                                <!-- <a href="javascript:void(0);" class="btn btn-info btn-md" onclick="pdf_report();"><i class="fa fa-file-pdf-o"></i> GET REPORT</a>
                                --> 
...
<script type='text/javascript'>
    ...
    function submit_data(rpt_type = 1) {
        ...
        if (moment(startdate).isValid() && moment(enddate).isValid()) {
            ...
            var ops_url = baseurl + 'fees/report/get-collection-class-wise-details';
            $.ajax({
                type: "POST",
                cache: false,
                // async: false,
                ...
                success: function(result) {
                    ...
                    try {
                        ...
                        if (data.status == 1) {
                            ...
                            $("body").append($a);
                            $a.attr("download", "collection_batch_wise_details.xlsx");
                            $a[0].click();
                            $a.remove();
