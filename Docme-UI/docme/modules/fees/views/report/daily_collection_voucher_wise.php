                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12" id="form_data">
                                <div class="form-group" id="data_1">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" data-date-startdate="2017-12-05" autocomplete="off" class="form-control" name="reportdate" id="reportdate" value="<?php echo date('d/m/Y'); ?> - <?php echo date('d/m/Y'); ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-xs-12" align="">
                                <input type="checkbox" value="1" checked name="user_wise_report" id="user_wise_report" class="i-checks" />
                                <span class="m-l-xs">Userwise Report</span>
                                <hr>
...
<script type='text/javascript'>
    ...
    /* function submit_data() {
        ...
        if (moment(startdate).isValid() && moment(enddate).isValid()) {
            ...
            var ops_url = baseurl + 'fees/report/get-daily-collection-voucher-wise';
            $.ajax({
                type: "POST",
                cache: false,
                // async: false,
                ...
                success: function(result) {
                    ...
                    try {
                        ...
                        if (data.status == 1) {
                            ...
                            $("body").append($a);
                            $a.attr("download", "daily_collection_voucher_wise.xlsx");
                            $a[0].click();
                            $a.remove();
    ...
    function submit_data(rpt_type = 1) {
        var user_wise_report = $("input[name='user_wise_report']:checked").val();
