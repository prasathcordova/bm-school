                ...
                <div class="ibox-content" id="report_param_loader">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" id="admission_div">
                            <div class="col-md-12">
                                <h3 id="admission_div_h">Collection report with Admission No.
                                    <hr>
                                </h3>
                                <b>Admission No.</b>
                        ...
                        <div id="advanced_search" class="row">
                            <div class="col-md-12">
                                <h3 id="advanced_search_h">Student Advanced Search for collection report
                                    <hr>
                                </h3>
                            </div>
...
<script type='text/javascript'>
    ...
    // $('body').on('click', 'input[name=radioInline]', function() {
    //     var id = $(this).attr('id');
    ...
    //
    // $('body').on('change', 'input[name=radioInline]', function() {
    //     if ($("input[name=radioInline]").is(":checked")) {
    //         alert('already checked');
    //     } else {
    //         alert($("input[name='radioInline']:checked").val());
    //     }

    // })
    // var radioValue = $("input[name='radioInline']:checked").val();
    // if (radioValue) {
    ...
    function search_name() {
        ...
        var ops_url = baseurl + 'fees/report/search-studentname-individual-collection';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function search_by_batch() {
        ...
        if (batch_id == -1) {
            ...
            var ops_url = baseurl + 'fees/report/advancesearch-studentname-individual-collection';
            $.ajax({
                type: "POST",
                cache: false,
                async: false,
    ...
    function changed_class() {
        ...
        var ops_url = baseurl + 'fees/report/get-batchdetails-individual-collection/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
