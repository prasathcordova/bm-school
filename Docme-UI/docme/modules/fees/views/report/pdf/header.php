<!-- <div style="text-align: center; padding-bottom:5px; display: block; font-family:Tahoma ;">
    <img src="<?php echo base_url('assets/theme/img/report/schooloxford.png'); ?>" alt="Techno Aliance" style="height: 100px;width:300;padding-top: 0px;margin-top: 0px;" />
    <p style="font-family:Tahoma ;">
        P.O Box :695009, Kallattumukku, Manacaud, Thiruvananthapuram, Kerala 
        <br />
        oxfordschool@gmail.com
        <br/>
        <br/>
