...
<body style="background: #fff !important;">
        ...
        <tbody>
            ...
            if (is_array($report_student_data) && !empty($report_student_data)) {
                ...
                foreach ($report_student_data as $acd_year => $acd_year_base_data) {
                    $row_total_amtt = 0;
                    echo '<tr class="bodyarea"><td colspan=' . ($colcount + 5) . ' style="text-align:left;"><b>&nbsp;Academic Year : ' . $acd_year . '</b></td></tr>';
                    foreach ($acd_year_base_data as $batch => $rpt_data) {
                        echo '<tr class="bodyarea"><td colspan=' . ($colcount + 5) . ' style="text-align:left;"><b>&nbsp;' . $batch . '</b></td></tr>';
            ?>
                        <thead>
                            <tr class="header">
                                <td width="3%">Sl.No.</td>
                                ...
                                foreach ($fee_code_base_data as $fcodes_temp) {
                                    if ($fcodes_temp['editable'] == 1) {
                                ?>
                                        <td style="text-align:right; width : <?php echo ($widthremain / (count($fee_code_base_data))); ?>%"><?php echo $fcodes_temp['fee_shortcode']; ?>&nbsp;</td>
                                <?php
                                    }
                                }
                                ?>
                    ...
                    ?>
                    <tr class="linetr">
                        <td colspan="<?php echo ($colcount + 5); ?>"></td>
                    </tr>
                    <tr class="bodyarea">
                    ...
                    <td colspan="<?php echo count($fee_code_base_data) + 1; ?>" style="text-align:right;"><?php echo my_money_format($batch_total); ?>&nbsp;&nbsp;</td>
                </tr> -->
            <?php
            ...
            ?>
            <tr class="footer">
                <td class="t-right" style="text-align:right;" colspan="<?php echo (($colcount + 5) - 2); ?>">Total Arrear (Current + Prev. Year(s))&nbsp;&nbsp;</td>
                <td style="text-align:right;" colspan="2"><?php echo my_money_format($grand_arrear_total); ?>&nbsp;&nbsp;</td>
            </tr>
            <!-- <tr class="footer">
    ...
    <table class="table table-bordered" width="100%" autosize="1">
        <tbody>
            <?php
            $i = 1;
            $totcolamt = 0;
            ...
            if (is_array($report_student_data_nd) && !empty($report_student_data_nd)) {
                foreach ($report_student_data_nd as $acd_year => $acd_year_base_data_nd) {
                    $row_total_amtt = 0;
                    $cccount = count($fee_code_base_data_nd) + 5;
                    echo '<tr class="bodyarea"><td colspan=' . $cccount . ' style="text-align:left;"><b>&nbsp;Academic Year : ' . $acd_year . '</b></td></tr>';
                    foreach ($acd_year_base_data_nd as $batch => $rpt_data_ar) {
                        echo '<tr class="bodyarea"><td colspan=' . $cccount . ' style="text-align:left;"><b>&nbsp;' . $batch . '</b></td></tr>';
            ?>
                        <thead>
                            <tr class="header">
                                <td width="3%">Sl.No.</td>
                ...
                ?>
                <tr class="linetr">
                    <td colspan="<?php echo count($fee_code_base_data_nd); ?>"></td>
                </tr>
                <tr class="bodyarea">
                    ...
                    foreach ($fee_code_base_data_nd as $fcodes_header4) {
                        if ($fcodes_header4['editable'] == 1) {
                            ...
                            echo '<td style="text-align:right;">' . my_money_format($cash_t) . '&nbsp;</td>';
                            $row_total_amtt = $row_total_amtt + $cash_t;
                        }
                    }
                    echo '<td style="text-align:right;">' . my_money_format($row_total_amtt) . '&nbsp;</td>';
                    ?>
                </tr>
                <!-- <tr class="linetr">
                    <td colspan="7"></td>
            ...
            ?>
                <tr class="bodyarea">
                    <td>No Other Fees are Demanded for any Student Currently</td>
                </tr>
            <?php
            }
            ?>
