                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-xs-12" id="form_data">
                                <div class="form-group" id="data_1">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" autocomplete="off" data-date-startdate="2017-12-05" class="form-control" name="reportdate" id="reportdate" value="<?php echo date('d/m/Y'); ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-xs-12" align="">
                                ...
                                <a href="javascript:void(0);" class="btn btn-warning btn-md" onclick="submit_data(2);"><i class="fa fa-file-excel-o"></i> Export to Excel</a>
...
<script type='text/javascript'>
    ...
    function submit_data(rpt_type = 1) {
        ...
        if (moment(frmdt).isValid()) {
            ...
            var ops_url = baseurl + 'fees/report/get-user-collection-details';
            $.ajax({
                type: "POST",
                cache: false,
                // async: false,
    ...
    /* function submit_data() {
        ...
        //var frmdt = $('#reportdate').data('datepicker').format('YYYY-MM-DD');
        var frmdt = moment($('#reportdate').val()).format('YYYY-MM-DD');
        if (!(moment(frmdt).isValid())) {
            swal('', 'Select a valid date range', 'info');
            return false;
        }
                ...
                success: function(result) {
                    ...
                    try {
                        ...
                        if (data.status == 1) {
                            ...
                            $("body").append($a);
                            $a.attr("download", "user_wise_collection_details.xlsx");
                            $a[0].click();
                            $a.remove();
