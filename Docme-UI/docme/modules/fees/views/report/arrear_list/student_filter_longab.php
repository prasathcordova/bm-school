                        ...
                        <div class="row" id="">
                            <div class="col-md-12">
                                ...
                                <div class="panel-heading">
                                    <i class="fa fa-info-circle" style="padding-right:10px;"></i>Long Absentee Arrear Report
...
<script type="text/javascript">
    ...
    function changed_class() {
        ...
        if (class_id == -1) {
            ...
            var ops_url = baseurl + 'fees/preload/get-batchdetails-for-arrear-longab-report/';
            $.ajax({
                type: "POST",
                cache: false,
                async: false,
    ...
    function submit_data(rpt_type = 1) {
        ...
        var ops_url = baseurl + 'fees/report/get-report-for-arrear-list-longab-with-batch/';
        $.ajax({
            type: "POST",
            cache: false,
            // async: false,
                ...
                success: function(result) {
                    ...
                    try {
                        ...
                        if (data.status == 1) {
                            ...
                            $("body").append($a);
                            $a.attr("download", "arrear_list_long_absentees.xlsx");
                            $a[0].click();
                            $a.remove();
