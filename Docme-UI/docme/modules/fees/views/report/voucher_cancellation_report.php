...
<script type='text/javascript'>
    ...
    /* function submit_data() {
        var displaytaxorvat = $('#displaytaxorvat').val();
        ...
        if (moment(startdate).isValid() && moment(enddate).isValid()) {
            ...
            var ops_url = baseurl + 'fees/report/get_voucher_cancellation_report';
            $.ajax({
                type: "POST",
                cache: false,
                async: false,
                ...
                success: function(result) {
                    ...
                    try {
                        ...
                        if (data.status == 1) {
                            ...
                            $("body").append($a);
                            $a.attr("download", "voucher_cancellation_report.xlsx");
                            $a[0].click();
                            $a.remove();
