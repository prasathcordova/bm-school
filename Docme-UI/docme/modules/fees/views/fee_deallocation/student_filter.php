        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title" style="border-bottom-color:#ffd300 !important;">
                    <h5><?php echo isset($sub_title) ? $sub_title : "FEE DEALLOCATION" ?></h5>
                    <div class="ibox-tools" id="add_type">
                        <a class="btn btn-danger" href="javascript:void(0)" onclick="load_fee_deallocation();" id="close_button" data-toggle="tooltip" title="Back to Filter" style="float: right; color: #fff;margin-top: -4px;"><i class="fa fa-backward"></i></a>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function scholarship_applied_list() {
        var ops_url = baseurl + 'fees/scholarship_applied_list/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function list_class_based_on_stream() {
        ...
        if (stream_id == -1) {
            ...
            //        var class_data = JSON.stringify(class_id);
            var ops_url = baseurl + 'fees/preload/list_class_based_on_stream/';
            $.ajax({
                type: "POST",
                cache: false,
                async: false,
