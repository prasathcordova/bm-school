        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title" style="border-bottom-color:#ffd300 !important;">
                    <h5><?php echo isset($sub_title) ? $sub_title : "FEES EXEMPTION MANAGEMENT" ?></h5>
                    <div class="ibox-tools" id="add_type">
                        <a class="btn btn-danger" href="javascript:void(0)" onclick="load_excemptions();" id="close_button" data-toggle="tooltip" title="Back to Filter" style="float: right; color: #fff;margin-top: -4px;"><i class="fa fa-backward"></i></a>
                        <a class="btn btn-info" href="javascript:void(0)" onclick="load_excemptions_approvals();" data-toggle="tooltip" title="Approvals" style="float: right; color: #fff;margin-top: -4px;"><i class="fa fa-check-circle"></i> Approvals</a>
                    </div>
                </div>
                <div class="ibox-content">
                    <div class="row" id="admission_div">
                        <div class="col-md-12">
                            <h3 id="admission_div_h">Student Direct Search For Fee Exemption
                                <hr>
                            </h3>
...
<script type="text/javascript">
    ...
    function changed_class() {
        ...
        var ops_url = baseurl + 'fees/get-batchdetails-for-collection/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
