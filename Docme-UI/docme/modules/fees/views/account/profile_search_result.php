        ...
        ?>
                <div class="col-lg-4">
                    <div class="contact-box center-version">
                        ...
                        <a href="javascript:void(0);" style="height:270px !important;">
                            <?php
                            $profile_image = "";
                        ...
                        <div class="contact-box-footer">
                            ...
                            <div class="m-t-xs btn-group">
                                <a href="javascript:void(0);" title="Show account details of <?php echo $student['student_name'] ?> " onclick="get_account_details('<?php echo $student['student_id']; ?>', '<?php echo $student['student_name'] ?>')" class="btn btn-md btn-info"><i class="fa fa-user-plus"></i> Show Account</a>
                            </div>
                        </div>
