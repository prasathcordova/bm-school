        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title" style="border-bottom-color:#ffd300 !important;">
                    <h5><?php echo isset($sub_title) ? $sub_title : "Student Account" ?></h5>
                    <div class="ibox-tools" id="add_type">
                        <a href="javascript:void(0)" onclick="load_student_account();" id="close_button" data-toggle="tooltip" title="Back to Filter" style="float: right; color: #B22222;"><i class="fa fa-backward"></i></a>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function search_name() {
        ...
        if (searchname.length < 3) {
            ...
            $("#close_button").show();
            var ops_url = baseurl + 'account/search-studentname-for-account';
            $.ajax({
                type: "POST",
                cache: false,
                async: false,
    ...
    function search_by_batch() {
        ...
        if (batch_id == -1) {
            ...
            $("#close_button").show();
            var ops_url = baseurl + 'account/advancesearch-studentname-for-account';
            $.ajax({
                type: "POST",
                cache: false,
                async: false,
    ...
    function changed_class() {
        ...
        var ops_url = baseurl + 'account/get-batchdetails-for-account/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
