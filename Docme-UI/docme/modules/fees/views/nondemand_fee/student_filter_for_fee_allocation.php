        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <a class="pull-right" href="javascript:void(0)" onclick="load_fee_student_allotment_student_wise()"><i class="fa fa-backward" style="font-size:22px;"></i></a>
                </div>
                ...
                <div class="ibox-content" id="fee_code_loader">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="ibox-content" id="item_list_detail" style="padding-bottom: 0px;">
                                <div class="row" id="">
                                    <div class="col-lg-12">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo $fee_codes['monthSpan'] == -2 ? 'One Time Fee' : $fee_codes['monthSpan'] . ' Month/s'; ?></td>
