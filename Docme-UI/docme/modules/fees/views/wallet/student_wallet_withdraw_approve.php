            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title" style="border-bottom-color:#ffd300 !important;">
                    ...
                    <div class="ibox-tools" id="add_type">
                        ...
                        <!-- <a data-toggle="modal" class="btn btn-primary btn-xs" data-toggle="tooltip" title="Save withdraw Approval / Rejection" data-placement="left" href="javascript:void(0)" onclick="save_withdraw_approve();"><i class="fa fa-floppy-o"></i> APPROVE / REJECT WITHDRAW REQUEST</a> -->
                    </div>
                </div>
                <div class="ibox-content" id="pay_loader">
                    ...
                    <div class="wrapper wrapper-content animated fadeInRight" id="student-data-container">
                        <div class="row">
                            ...
                            <input type="hidden" name="amt_to_pay" id="amt_to_pay" value="<?php echo set_value('amount_with_draw', isset($approve_data['amount']) ? round($approve_data['amount'], 2) : '0'); ?>" />
                                ...
                                <div class="ibox-content" style=" padding-right: 1%;" id="fees_summary">
                                    <div class="row clearfix">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <div class="form-line <?php
                                                                        ...
                                                                        ?> ">
                                                    <input type="text" maxlength="20" style="background-color: #FFFFFF; text-align:right;" readonly="" class="form-control allownumericwithdecimal" name="amount_with_draw" id="amount_with_draw" value="<?php echo set_value('amount_with_draw', isset($approve_data['amount']) ? my_money_format($approve_data['amount']) : '0'); ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <div class="form-line <?php
                                                                        ...
                                                                        ?> ">
                                                    <input type="text" style="background-color: #FFFFFF" readonly="" maxlength="50" class="form-control" name="reason" id="reason" value="<?php echo set_value('reason', isset($approve_data['reason']) ? $approve_data['reason'] : ''); ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12" style="padding-bottom:10px;padding-top: 10px;">
                                            <div class="radio radio-info radio-inline ">
                                                <input type="radio" id="inlineRadio1" value="Approve" name="radioInline" checked="" class="approve-radio" onchange="setpayment();">
                                                <label for="inlineRadio1"> Approve </label>
                                            </div>
                                            <div class="radio radio-danger radio-inline">
                                                <input type="radio" id="inlineRadio2" value="Reject" name="radioInline" class="approve-radio" onchange="setpayment();">
                                        ...
                                        <div class="col-md-12">
                                            <b>Comments</b>
                                            <div class="form-group">
                                                <input type="text" style="background-color: #FFFFFF" class="form-control text-uppercase" name="approval_c" id="approval_c" value="" placeholder="Enter Comment" />
                                            </div>
                                        </div>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            <div class="row">
                                                                                <div class="form-group " style="padding-left: 30px;padding-right: 30px;">
                                                                                    ...
                                                                                    <input type="text" style="background-color: #FFFFFF; text-align:right;" class="form-control" disabled="" name="pay_amount" id="pay_amount" value="<?php echo set_value('amount_with_draw', isset($approve_data['amount']) ? my_money_format($approve_data['amount']) : '0'); ?>">
                                                                                </div>
                                                                                <hr>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-lg-12 col-md-12">
                                                                                    <div class="form-group ">
                                                                                        <label>Amount Total</label>
                                                                                        <input type="text" style="background-color: #FFFFFF; text-align:right;" class="form-control" disabled="" name="pay_amount1" id="pay_amount1" value="<?php echo set_value('amount_with_draw', isset($approve_data['amount']) ? my_money_format($approve_data['amount']) : '0'); ?>">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="clearfix"></div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 reject_div hidden">
                                            <a data-toggle="modal" class="btn btn-danger btn-large" data-toggle="tooltip" title="Reject Withdraw Request" data-placement="left" href="javascript:void(0)" onclick="save_withdraw_approve();"><i class="fa fa-times"></i> REJECT WITHDRAW REQUEST</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                if (data.status == 1) {
                    var voucher = data.voucher_no;
                    var voucher_id = data.voucher_id;
                    swal('', 'Cheque payment of ' + amt_to_pay + '/- for withdrawal from wallet for the student ' + student_name + ' completed successfully with voucher number : ' + voucher + '.', 'success');
                    print_voucher(voucher_id, voucher, 'fee');
                    show_withdraw_request_list();
                } else if (data.status == 2) {
                    if (data.message) {
