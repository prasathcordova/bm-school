        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title" style="border-bottom-color:#ffd300 !important;">
                    <h5><i class="fa fa-money-circle" style="padding-right:10px;"></i><?php echo isset($sub_title) ? $sub_title : "Docme Wallet" ?></h5>
                    <div class="ibox-tools" id="add_type">
                        <a href="javascript:void(0)" onclick="load_wallet_student();" id="close_button" data-toggle="tooltip" title="Back to Filter" style="float: right; color: #B22222;"><i class="fa fa-backward"></i></a>
                    </div>
                </div>
                <div class="ibox-content">
                    <div class="row" id="admission_div">
                        <div class="col-md-12">
                            <h3 id="admission_div_h">Student Direct Search For Docme Wallet
                                <hr>
                            </h3>
...
<script type="text/javascript">
    ...
    function search_name() {
        ...
        if (searchname.length < 3) {
            ...
            $("#close_button").show();
            var ops_url = baseurl + 'fees/search-studentname-for-wallet';
            $.ajax({
                type: "POST",
                cache: false,
                async: false,
    ...
    function search_by_batch() {
        ...
        if (batch_id == -1) {
            ...
            $("#close_button").show();
            var ops_url = baseurl + 'fees/advancesearch-studentname-for-wallet';
            $.ajax({
                type: "POST",
                cache: false,
                async: false,
    ...
    function changed_class() {
        ...
        var ops_url = baseurl + 'fees/get-batchdetails-for-wallet/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
