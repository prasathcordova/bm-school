                                ...
                                <div class="row" id="">
                                    <div class="col-lg-12">
                                        <div class="panel panel-info">
                                            <div class="panel-heading">
                                                Available Fee Codes
                                                <a href="javascript:void(0)" onclick="load_priority();" id="close_button" data-toggle="tooltip" title="Back" style="float: right; color: #B22222;"><i class="fa fa-backward"></i></a>
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="panel panel-success">
                                            <div class="panel-heading">
                                                Fee Codes Assigned for the students with Priority - <?php echo $priority_number; ?>
                                                <!--  <span  class="label label-info pull-right"><a herf="javascript:void(0);" onclick="save_feecode_priority_assignment();"> <i class="fa fa-save" style=" font-size:19px;"></i></a></span>-->
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <div class="form-line">
                                                                                    <input type="text" placeholder="Enter Concession %" id="discount" name="discount" class="form-control discount_data decimalCheck_perc text-right" onkeypress="return validateFloatKeyPress(this,event);" maxlength="3" value="<?php echo round($feecode_existing['discount'], 2); ?>" data-id="<?php echo $feecode_existing['fee_code_id']; ?>" data-feecode="<?php echo $feecode_existing['feeCode'] ?>" />
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
...
<script type="text/javascript">
    ...
    //     }
    // }
    // $('body').on('keyup', '.discount_data', function() {
    ...
    function add_feecode(id, feecode, desc) {
        ...
        if (flag1 == 1) {
            ...
            var newrow = table.row.add([
                feecode,
                desc,
                '<div class="form-group"><div class="form-line"> <input type="text" placeholder="Enter Concession %" id="discount" name="discount"class="form-control discount_data decimalCheck_perc text-right"  onkeypress="return validateFloatKeyPress(this,event);" maxlength="3" value="0" data-id="' + id + '" data-feecode ="' + feecode + '" />      </div> </div>',
                '<a title="Remove Feecode" href="javascript:void(0)" onclick="delete_allotted_fee_code(this);"><i class="fa fa-trash" style="font-size:16px;"></i></a>'
            ]).draw();
    ...
    function save_feecode_priority_assignment() {
        ...
        var ops_url = baseurl + 'fees/save-manage-priority/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
            ...
            success: function(result) {
                ...
                if (data.status == 1) {
                    ...
                    //swal('Success', 'Concession for fee code for student priority , ' + priority_number + ' assigned successfully.', 'success');
