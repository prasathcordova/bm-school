                    ...
                    <?php 
                        ...
                        ?>
                            ...
                            ?>
                                ...
                                ?>
                                    <tr>
                                        <td colspan="<?php echo $colspan; ?>" style="background-color: #e7e8e8; font-size: 14px;" class="accordian accordian_<?php echo $apppage['menuuniqueid']; ?>"><label style="font-weight: normal;"><input type="checkbox" class="submenu subpage_<?php echo $apppage['menuuniqueid']; ?> subpage2_<?php echo $apppagesArr['apppagesuniqueid']; ?>" onclick="select_all_subaction('<?php echo $apppagesArr['apppagesuniqueid']; ?>', '<?php echo $apppage['menuuniqueid']; ?>')" value=""> &nbsp; <?php echo $pagename; ?></label></td>
                                    </tr>
                                <?php
                                ...
                                if (isset($assigned_roles) && !empty($assigned_roles)) {
                                    foreach ($assigned_roles as $selected) {
                                        $checkedvalue[] = $selected['apppagesuniqueid'] . "," . $selected['operationuniqueid'];
                                    }
                                ?>
                                    <td style="border: none;white-space: nowrap;font-size:13px;float:left;display:block;" class="accordian accordian_<?php echo $apppage['menuuniqueid']; ?>">
                               ...
                               <?php } else {
                                ...
                                ?>
                                                <td style=" border: none; white-space: nowrap;font-size:11px;float:left;display:block;" class="accordian accordian_<?php echo $apppage['menuuniqueid']; ?>">
                                                    ...
                                                    <input type="checkbox" class="subaction_<?php echo $apppage['menuuniqueid']; ?> page_action_<?php echo $apppagesArr['apppagesuniqueid']; ?> page_action2_<?php echo $operations['operationuniqueid']; ?>" onclick="select_subpage('<?php echo $apppagesArr['apppagesuniqueid']; ?>', '<?php echo $apppage['menuuniqueid']; ?>', '<?php echo $operations['operationuniqueid']; ?>')" name="operationuniqid[]>" value="<?php echo $pageactionvalue; ?>">&nbsp;
...
<script type="text/javascript">
    ...
    function check_supages_checkbox(apppagesuniqueid, menuuniqueid) {
        ...
        if (action_count <= 0) {
            ...
            $('.subpage2_' + apppagesuniqueid).prop('checked', false);
        }
    ...
    function check_mainmenu_checkbox(menuuniqueid) {
        ...
        if (subpage_count <= 0) {
            ...
            $('.selectall_' + menuuniqueid).prop('checked', false);
        }
    }
