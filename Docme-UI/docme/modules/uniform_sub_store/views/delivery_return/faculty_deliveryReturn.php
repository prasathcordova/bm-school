                    ...
                    <div class="panel-body">
                        <div class=" input-group" style="padding-bottom: 5%;">
                            ...
                            <span class="input-group-btn">
                                <button type="button" id="button_id" class="btn btn btn-primary" onclick="uniform_search_faculty_delivery_return();"> <i class="fa fa-search"></i></button>
...
<script>
    ...
    function uniform_select_items(id) {
        ...
        var ops_url = baseurl + 'uniform/substore/faculty-deliveryReturn-pack-details';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function uniform_search_faculty_delivery_return() {
        $('#item-replace-container').html('');
        $('#item-data-container').html('');
        var searchvoucher = $("#searchitem").val();
        var emp_id = $("#emp_id").val();

        var ops_url = baseurl + 'uniform/sales/faculty-voucher-deliveryretn';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
