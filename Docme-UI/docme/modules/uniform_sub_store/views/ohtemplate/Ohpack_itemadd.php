    ...
    function uniform_add_list(item_code, barcode, itemtype_name, price, item_id, tax_type, tax_value) {
        ...
        if (flag == 1) {
            ...
            dTable.row.add([
                ...
                '<input type="textbox" disabled size="4" class="form-control numericDecimal" data-taxtype = "' + tax_type + '" data-taxamount = "' + tax_value + '" name ="price" id="price_' + item_id + '" value= ' + price + ' />',
