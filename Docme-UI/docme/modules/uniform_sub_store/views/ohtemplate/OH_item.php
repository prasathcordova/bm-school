                                                        ...
                                                        ?>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><a href="javascript:void(0);" onclick="uniform_student_assignment('<?php echo $master['oh_data']['id']; ?>', '<?php echo $template['template_id']; ?>');"><span class="label label-warning pull-right">Select</span></a> </td>
                                                                </tr>
...
<script type="text/javascript">
    function uniform_openhouse() {
        ...
        var ops_url = baseurl + 'uniform/substore/item-templatepack_search/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function uniform_student_assignment(openhouse_id, template_id) {
        //        alert(openhouse_id);
        //        alert(template_id);return false;
        var ops_url = baseurl + 'uniform/substore/item-stud_attach/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
