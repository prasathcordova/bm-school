                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xs-12 col-md-12 ">
                            <div class="form-group text-right" id="search_filter_btn">
                                <button type="button" onclick="uniform_search_student();" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Search Students">Filter Students</button>
                            </div>
                        </div>
                        <div class="col-lg-12">
...
<script>
    ...
    function uniform_load_students_after_filter(batchid, acd_yr = 0) {
        ...
        var ops_url = baseurl + 'substore/ohstudent-profile';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
