    ...
    <div class="ibox " >
        <div class="ibox-title">
            ...
            <div class="ibox-tools">
                ...
                <span><a href="javascript:void(0)"  onclick="uniform_save_data()" > <i style="font-size: 30px !important;  float: right;color: #23C6C5;" class="material-icons" data-toggle="tooltip" title="Save">save</i></a> </span>
            </div>
        </div>
