                ...
                <div class="ibox-content">
                    ...
                    <div class="input-group" style="margin-bottom:26px">
                        ...
                        <span class="input-group-btn">
                            <button type="button" id="button_id" class="btn btn-info" onclick="uniform_search_template();"> Search</button>      
                                            ...
                                            <div class="ibox-content">
                                                <li  style="list-style: none;"class="warning-element ui-sortable-handle" id="task5">
                                                    ...
                                                    <div class="agile-detail" style="padding-top: 4px !important">
                                                        <?php
                                                        if (check_permission(553, 1054, 0)) {
                                                            ?>
...
<script type="text/javascript">
    ...
    function uniform_search_template() {
        var search_template = $("#search_template").val();
        var ops_url = baseurl + 'uniform/substore/search_template_byname/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function uniform_items_add(id, name) {
        var ops_url = baseurl + 'uniform/substore/items-adding/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
