            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools" id="add_type">
                        ...
                        <span><a href="javascript:void(0);" onclick="uniform_submit_edit_data('<?php echo $master_data['id'] ?>');"> <i style="font-size: 30px !important; float: right; color: #23C6C5; padding-right: 10px;" class="material-icons" data-toggle="tooltip" title="Save">save</i></a> </span>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function uniform_submit_edit_data(master_id) {
