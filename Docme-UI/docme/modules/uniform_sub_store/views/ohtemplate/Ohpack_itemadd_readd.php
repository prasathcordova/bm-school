            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools" id="add_type">
                        <span><a href="javascript:void(0);" onclick="uniform_submit_data();" data-toggle="tooltip" title="Save"> <i style="font-size: 35px !important;  float: right;color: #23C6C5;" class="material-icons">save</i></a> </span>
                    </div>
                </div>
                                                ...
                                                <div class="scroll_content">
                                                    <div class=" input-group">
                                                        ...
                                                        <span class="input-group-btn">
                                                            <button type="button" id="button_id" class="btn btn btn-primary" onclick="uniform_search_item();"> <i class="fa fa-search"></i></button>
                                                        </span>
                                                    </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-striped table-bordered table-hover dataTables-example" id="tbl_selected">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                //                                                                  
                                                                foreach ($oh_data as $item) {

                                                                    if (isset($item['items_data']) && !empty($item['items_data']) && is_array($item['items_data'])) {
                                                                        foreach ($item['items_data'] as $value) {

                                                                            $temp[] = $value['item_id'];
                                                                            //                                                                            dev_export($value['rate']);die;
                                                                ...
                                                                ?>
                                                                            ...
                                                                            <tr role="row" class="odd">
                                                                                <td class="capitalize sorting_1" tabindex="0"><?php echo $value['item_code'] ?></td>
                                                                                <td><?php echo $value['barcode'] ?></td>
                                                                                <td><?php echo $value['item_code'] ?></td>
                                                                                <td><input type="textbox" disabled class="form-control" name="qty" value="<?php echo $value['qty'] ?>" id="item_<?php echo $value['item_id'] ?>" data-submit="1"></td>
                                                                                <td><input type="textbox" disabled="" size="4" class="form-control" data-taxtype="<?php echo $value['tax_type'] ?>" data-taxamount="<?php echo $value['tax_value'] ?>" name="price" id="price_<?php echo $value['item_id'] ?>" value="<?php echo $price ?>"></td>
                                                                                <td><a href="javascript:void(0);" data-toggle="tooltip" data-placement="right" title="Confirm item" style="display:none;" data-original-title="" id="confirm_<?php echo $value['item_id'] ?>" onclick="valuedisplay('<?php echo $value['item_id'] ?>', '<?php echo $price ?>', '<?php echo $value['tax_type'] ?>', '<?php echo $value['tax_value'] ?>')"><i class="fa fa-check" style="font-size: 24px; color: #23C6C8; margin: 2%; "></i></a>
                                                                                    <span id="confirmed_<?php echo $value['item_id'] ?>" class="label label-warning pull-left">CONFIRMED</span></td>
                                                                                <td><a href="javascript:void(0);"><span id="discard_<?php echo $value['item_id'] ?>" class="label label-warning pull-left" onclick="uniform_deletedisplay('<?php echo $value['item_id'] ?>', '<?php echo $price ?>', '<?php echo $value['tax_type'] ?>', '<?php echo $value['tax_value'] ?>');"><i class="fa fa-trash-o" aria-hidden="true"></i></span></a></td>
                                                                            </tr>
                                                                    <?php
                                                                            if ($value['tax_type'] == 'P') {
                                                                                $vat_amt = round((($price * $value['qty'])) * $value['tax_value'] / 100, 2, PHP_ROUND_HALF_UP);
                                                                            } else {
                                                                                $vat_amt = round($value['tax_value'] * $value['qty'], 2, PHP_ROUND_HALF_UP);
                                                                            }

                                                                            $total_vat_amount = $total_vat_amount + $vat_amt;

                                                                            $total_sub_total = $total_sub_total + round(($price * $value['qty']), 2, PHP_ROUND_HALF_UP);
                                                                        }
                                                                    }
                                                                    //                                                                    dev_export($total_vat_amount);die;
                                                                    //                                                                }
                                                                    //                                                                    
                                                                    $total_discount_amount = $item['master_data']['discount'];
                                                                    $round_off = $item['master_data']['roundoff'];
                                                                    $total_before_roundoff = round($total_sub_total + $total_vat_amount - $total_discount_amount, 2, PHP_ROUND_HALF_UP);
                                                                    $grand_total = round($total_sub_total + $total_vat_amount + $round_off - $total_discount_amount, 0, PHP_ROUND_HALF_UP);
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" id="total_qty" style="background-color: #FFFFFF;" class="form-control text-uppercase" disabled name="description" value="<?php echo isset($item['master_data']['total_qty']) ? $item['master_data']['total_qty'] : '' ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <!--<input type="email" class="form-control disabled" id="inputEmail3"  placeholder="">-->
                                                    <input type="text" style="background-color: #FFFFFF;" class="form-control text-uppercase" disabled name="description" id="sub_total" value="<?php echo $total_sub_total ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" value="<?php echo $total_vat_amount ?>" disabled="" style="background-color: #FFFFFF;" class="form-control" id="vat" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6" id="check_dis" style="display:none;">
                                            <label class="form-check-label col-sm-12 " style="font-weight:normal;">
                                                ...
                                                <b>Discount</b>(-)
                                                <input class="form-check-input" style="margin:0 0 0 15px;" type="radio" name="gridRadios" id="dis_rate" value="0" <?php if ($item['master_data']['discount_type'] != 'p') { ?> checked <?php } ?>>
                                                Rate(%)
                                                <input class="form-check-input" style="margin:0 0 0 15px;" type="radio" name="gridRadios" id="dis_fixed" value="1" <?php if ($item['master_data']['discount_type'] === 'F') { ?> checked <?php } ?>>
                                                Fixed


                                            </label>
                                            <div class=" input-group">
                                                <input type="text" value="<?php echo $total_discount_amount ?>" class="form-control" id="discount" placeholder="">
                                                <p style="display:inline-block; padding: 0 0 0 5px"></p>
                                                <span class="input-group-btn">
                                                    <button style="margin-bottom: 18px;" type="button" class="btn btn btn-primary" onclick="uniform_change_valuedisplay();">Go</button>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" style="background-color: #FFFFFF;" class="form-control" id="roundoff" placeholder="" value="<?php echo $total_roundoff ?>" placeholder="Round Off(+/-)" onchange="round_off_change()">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" style="background-color: #FFFFFF;" value="<?php echo $grand_total ?>" disabled class="form-control" id="finaltotal" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php $value_after_tax = (isset($item['master_data']['sub_total']) ? $item['master_data']['sub_total'] : 0) + (isset($item['master_data']['tax_amount']) ? $item['master_data']['tax_amount'] : 0) ?>
<input type="hidden" name="itemdata" id="itemdata" value="<?php echo json_encode($temp); ?>" />
<input type="hidden" name="value_after_tax" id="value_after_tax" value="<?php echo $value_after_tax; ?>" />
...
<script type="text/javascript">
    ...
    function uniform_add_to_list() {
        if ($('#flag_value').val() == 1) {
            ...
            uniform_add_list(item_code_id, barcode_id, itemtype_name_id, price_id, itemsid_id, tax_type_id, tax_value_id);
    ...
    function uniform_search_item() {
        ...
        var ops_url = baseurl + 'uniform/substore/search-ohstoredata/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function uniform_add_list(item_code, barcode, itemtype_name, price, item_id, tax_type, tax_value) {
        ...
        if (flag == 1) {
            ...
            dTable.row.add([
                ...
                '<input type="textbox" size="4" class="form-control numericDecimal" data-taxtype = "' + tax_type + '" data-taxamount = "' + tax_value + '" name ="price" id="price_' + item_id + '" value= ' + price + ' />',
                ...
                '<a href="javascript:void(0)" data-toggle="tooltip" title = "Remove this item from list"><span id="discard_' + item_id + '" class="label label-warning pull-left" onclick="uniform_deletedisplay(' + item_id + ',' + price + ' ,\'' + tax_type + '\',' + tax_value + '  );" ><i class="fa fa-trash-o" aria-hidden="true"></i></span></a>'
    ...
    function uniform_change_valuedisplay() {
        ...
        if (disc_type == 1) {
            ...
            if (discount_amount > net_val_after_tax) {
    ...
    function uniform_submit_data() {
        ...
        var ops_url = baseurl + 'uniform/substore/save-oh_item/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
