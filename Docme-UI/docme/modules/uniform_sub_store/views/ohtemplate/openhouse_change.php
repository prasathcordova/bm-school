            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools" id="ibox_tool">
                        <span><a href="javascript:void(0)" title="Save" id="oh_student_remove_save" onclick="uniform_submit_openhouse_remove()"> <i style="font-size: 30px !important;  color: #23C6C5;" class="material-icons">save</i></a> </span>
                        <span><a href="javascript:void(0)" title="Close" onclick="uniform_remove_student_allotment()"> <i style="font-size: 30px !important;  color: #23C6C5;" class="material-icons">close</i></a> </span>
                    </div>
                </div>
                                                        ...
                                                        ?>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><a href="javascript:void(0);" onclick="uniform_list_student_assigned('<?php echo $master['oh_data']['id']; ?>', '<?php echo $template['template_id']; ?>', '<?php echo $flag ?>');"><span class="label label-warning pull-right">List <i class="fa fa-arrow-right"></i></span></a> </td>
                                                                </tr>
...
<script type="text/javascript">
    function uniform_list_student_assigned(openhouse_id, template_id, flag) {
        if (flag == 0) {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                if (data.status == 1) {
                    ...
                    uniform_remove_student_allotment();
                    return true;
                    //                    alert('No data loaded');
                }
            }
    ...
    function uniform_submit_openhouse_remove() {
        ...
        var ops_url = baseurl + 'uniform/substore/remove-stud_item_attach/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function uniform_openhouse() {
        ...
        var ops_url = baseurl + 'uniform/substore/openhouse-change_search/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
