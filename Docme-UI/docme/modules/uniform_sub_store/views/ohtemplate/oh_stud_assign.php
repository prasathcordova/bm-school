            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools" id="add_type">
                        <a href="javascript:void(0);" onclick="uniform_item_list();" id="item_list" class="pull-right btn-xs btn btn-primary">Item list </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="ibox-content" style="display:inline-block; width:100%;">
                                    ...
                                    <div class="row clearfix" id="pagetop">
                                        <div class="col-lg-4 col-xs-12 col-md-12">
                                            <div class="form-group ">
                                                ...
                                                <select class="select2_registration form-control" id="academic_year" name="academic_year" style="width: 100%" onchange="uniform_load_batch_data();">
                                                    <?php
                                        ...
                                        <div class="col-lg-4 col-xs-12 col-md-12">
                                            <div class="form-group ">
                                                <label>Stream *</label>
                                                <select class="select2_registration form-control" id="stream_id" name="stream_id" onchange="uniform_load_batch_data();">
                                                    <?php
                                        ...
                                        <div class="col-lg-4 col-xs-12 col-md-12">
                                            <div class="form-group ">
                                                <label>Session *</label>
                                                <select class="select2_registration form-control" id="session_id" name="session_id" onchange="uniform_load_batch_data();">
                                                    <?php
                                        ...
                                        <div class="col-lg-4 col-xs-12 col-md-12">
                                            <div class="form-group ">
                                                <label>Class *</label>
                                                <select class="select2_registration form-control" id="class_id" name="class_id" onchange="uniform_load_batch_data();">
                                                    <?php
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <a href="javascript:void(0);" onclick="uniform_search_student();" id="search_student" class="pull-right btn-xs btn btn-primary">Search <i class="fa fa-search"></i></a>
...
<script>
    ...
    function uniform_load_batch_data() {
        var academic_year = $('#academic_year').val();
        var stream_id = $('#stream_id').val();
        var session_id = $('#session_id').val();
        var class_id = $('#class_id').val();

        var ops_url = baseurl + 'uniform/substore/batch-stud_item_attach/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function uniform_search_student() {
        ...
        var ops_url = baseurl + 'uniform/substore/search-stud_item_attach/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function uniform_save_data() {
        ...
        var ops_url = baseurl + 'uniform/substore/save-stud_item_attach/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
