                    ...
                    <div class="ibox-content">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="button" class="btn btn-info" onclick="uniform_search_name('<?php echo $acdyr_id; ?>', '<?php echo $batch_id; ?>');"> Search</button>
                                                ...
                                                <div class="contact-box center-version">
                                                    ...
                                                    <div class="contact-box-footer" style="padding: 5px 5px;">
                                                        <div class="m-t-xs btn-group">
                                                            <a href="javascript:void(0);" onclick="uniform_oh_bill('<?php echo $student['student_id']; ?>')" class="btn btn-xs btn-white"><i class="fa fa-user-plus"></i>OH Billing</a>
                                                            <a href="javascript:void(0);" onclick="uniform_oh_bill('<?php echo $student['student_id']; ?>')" class="btn btn-xs btn-white"><i class="fa fa-user-plus"></i>Other Billing</a>
