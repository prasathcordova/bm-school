        ...
        <div class="card">
            <div class="header">
                <h2 style="padding-bottom: 10px;font-size: 16px;"><?php echo isset($title) ? $title : "NO TITLE PROVIDED" ?>
                    ...
                    <span><a href="javascript:void(0);"  onclick="uniform_submit_data();" > <i style="font-size: 30px !important; float: right; color: #23C6C5; padding-right: 10px;" class="material-icons" data-toggle="tooltip" title="Save">save</i></a> </span>
                ...
                <div class="row clearfix">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            ?> "> 
                                <input type="text" maxlength="30" class="form-control text-uppercase"  name="oh_name" id="oh_name" value="" />
                            </div>                           
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            ?> ">
                                <input type="text" maxlength="150" class="form-control text-uppercase" name="oh_description" id="oh_description" value="" />
                            </div>
                        </div>
                    </div>
