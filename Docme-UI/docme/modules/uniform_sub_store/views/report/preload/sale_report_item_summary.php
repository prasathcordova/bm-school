                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-xs-6">
                                        <div class="form-group"><label class="control-label">Sale Type</label>
                                            <select class="form-control" name="type" id="type">
                                                <option value="1">Loose Packings</option>
                                                <option value="3">OH Packings</option>
                                                <option value="2">Specimen</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-xs-12" align="center">
                                        <a href="javascript:void(0);" class="btn btn-primary btn-sm" onclick="uniform_submit_data();"> Report</a>
    ...
    <script type="text/javascript">
        ...
        function uniform_submit_data() {
            ...
            if (moment(startdate).isValid() && moment(enddate).isValid()) {
                ...
                var ops_url = baseurl + 'uniform/substore-report/sale-itemwise-summary-report/';
                $.ajax({
                    type: "POST",
                    cache: false,
                    async: false,
