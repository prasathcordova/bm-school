        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5 style="font-size: 15px"><?php echo isset($sub_title) ? $sub_title : "NO TITLE PROVIDED" ?>
                        ...
                        <div class="col-lg-12">
                            <div class="ibox">
                                <div class="ibox-title">
                                    ...
                                    <h5 style="font-size: 15px"><?php echo base64_decode($allot_data['master_data']['description']) ?></h5>
                                </div>
...
<script type="text/javascript">
    ...
    function uniform_select_item(item_id, item_name, item_code, selling_price, barcode) {
        ...
        if (flag == 1) {
            ...
            dTable.row.add([
                ...
                '<a href="javascript:void(0);" data-toggle="tooltip" data-placement="right" title="Confirm item" data-original-title="" id="confirm_' + item_id + '" onclick="uniform_valuedisplay(' + item_id + ',' + selling_price + ')"><i class="fa fa-check" style="font-size: 24px; color: #23C6C8; margin: 2%; "></i></a>'
    ...
    function uniform_valuedisplay(item_id, selling_price) {
        var selling_price = selling_price;
