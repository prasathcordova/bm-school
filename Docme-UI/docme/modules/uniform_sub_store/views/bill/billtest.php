                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <div class="input-group"><input type="text" id="searchname" name="searchname" placeholder="Enter Admission Number" class="form-control"> <span class="input-group-btn">
                                    <button type="button" id="search_name_btn" class="btn btn-primary" onclick="uniform_search_name();"><i class="fa fa-search"></i> </button> </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-line">
                            <div class="input-group"><input type="text" placeholder="Enter Student Name" id="sname" name="sname" class="form-control"> <span class="input-group-btn">
                                    <button id="btn_id_2" type="button" class="btn btn-primary" onclick="uniform_searchadvance_filtername();"><i class="fa fa-search"></i>
                                    </button> </span></div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function uniform_search_name() {
        ...
        var ops_url = baseurl + 'uniform/bill/search-studentname';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function uniform_searchadvance_filtername() {
        ...
        var ops_url = baseurl + 'uniform/bill/advancesearch-studentname';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
