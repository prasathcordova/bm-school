                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="1" style="padding-top:20px;text-align: right;">
                                <p id="tbl_subtotal"><?php echo $details_data['master_data']['sub_total'] + $details_data['master_data']['round_off']; ?></p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="1" style="padding-top:10px;text-align: right;">
                                <p id="tbl_subtotal"><?php echo ($details_data['master_data']['sub_total'] + $details_data['master_data']['round_off'] - $details_data['master_data']['discount_amount']); ?></p>
                            </td>
                        </tr>
                        <tr>
