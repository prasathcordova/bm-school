                ...
                <?php } else { ?>
                    <div class="col-md-6" id="check_dis" style="margin-top: -197px;">
                        ...
                        <div class=" input-group">
                            ...
                            <p style="display:inline-block; padding: 0 0 0 5px"></p>
                            <span class="input-group-btn">
                                <button style="margin-bottom: 18px;" disabled="" type="button" class="btn btn btn-primary" onclick="uniform_change_valuedisplay();">Go</button>
                            </span>
                        </div>
                    </div>
                <?php } ?>
                            ...
                            <div id="collapseOne" class="panel-collapse collapse">
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <a class="btn btn-info" style="margin-left:30px;" href="javascript:void(0);" onclick="uniform_cash_pay();">
                                            <i class="fa fa-money">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapse3" class="panel-collapse collapse">
                                <div class="panel-body">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="row">
                                            <a class="btn btn-info" style="margin-left:30px;" href="javascript:void(0)" onclick="uniform_cheque_pay();">
                                                <i class="fa fa-money">
                                                    Make a payment!
                                                </i>
                                            </a>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <form role="form" id="payment-form">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <a class="btn btn-info" style="margin-left:30px;" href="javascript:void(0);" onclick="uniform_card_pay();">
                                                        <i class="fa fa-money">
...
<script>
    ...
    function uniform_cash_pay() {
        ...
        //        alert(cashbilldata);
        var ops_url = baseurl + 'uniform/substore-bill-pay/pay-cash-amount';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function uniform_cheque_pay() {
        ...
        var cashbilldata = JSON.stringify(cash_billing);
        //        alert(cashbilldata);
        var ops_url = baseurl + 'uniform/substore-bill-pay/pay-cheque-amount';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
