        ...
        <div class="col-lg-4">
            <div class="ibox float-e-margins">
                <div class="ibox-title" style="padding: 5PX 15PX 2px 15px;min-height: 35px;">
                    ...
                    ?>
                        <a href="javascript:void(0)" onclick="uniform_select_items('<?php echo $packlist['id']; ?>', '<?php echo $packlist['barcode']; ?>');">
                            <span class="label label-info pull-right">Show Pack Details </span>
                        </a>
                    <?php } else { ?>
                        <a href="javascript:void(0)" onclick="uniform_select_bill('<?php echo $packlist['billmasterid']; ?>', '<?php echo $packlist['billing_code']; ?>');">
