                    ...
                    <div class="ibox-content">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="button" id="search_name_btn" class="btn btn-info" onclick="uniform_search_name();"> Search</button>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="contact-box center-version">
                                                    <a href="javascript:void(0);">
                                                        ...
                                                        <h3 class="m-b-xs pro-name" style="    overflow: overlay;height: 70px; "><strong><?php echo $staff['Emp_Name'] ?></strong></h3>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="project-status" style="text-align:center;">
                                                                    <span class="label label-primary" style="font-size:12px;">Designation:<?php echo $staff['Designation'] ?></span>
                                                                </td>
                                                            </tr>
                                                    ...
                                                    <div class="contact-box-footer" style="padding: 5px 5px;">
                                                        <div class="m-t-xs btn-group">
                                                            <a href="javascript:void(0);" title="Specimen issue <?php echo $staff['Emp_Name'] ?>" onclick="uniform_specimen_packing('<?php echo $staff['Emp_id']; ?>')" class="btn btn-xs btn-white"><i class="fa fa-user-plus"></i>Specimen Issue</a>
                                                            <!--<a href="javascript:void(0);" onclick="other_bill('<?php echo $staff['Emp_id']; ?>')" class="btn btn-xs btn-white"><i class="fa fa-user-plus"></i>Other Billing</a>-->
                                                            <!--<a href="javascript:void(0);" onclick="send_personal_email('<?php echo $staff['Emp_id']; ?>', '<?php // echo $acdyr_id;     
                                                                                                                                                                ?>', '<?php // echo $batch_id;     
                                                                                                                                                                                                    ?>')" class="btn btn-xs btn-white "><i class="fa fa-billing"></i>Other Billing</a>-->
                                                            <!--<a href="javascript:void(0);" onclick="fees_detail('<?php echo $staff['Emp_id']; ?>')" class="btn btn-xs btn-white"><i class="fa fa-user-plus"></i> Fee Details</a>-->
                                                        </div>
                                                    </div>
...
<script>
    ...
    function uniform_specimen_packing(Emp_id) {
    ...
    function uniform_search_name() {
        ...
        var ops_url = baseurl + 'uniform/substore/search-teachername';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
