                ...
                <div class="ibox-content">
                    ...
                    <div class="">
                        ...
                        <div class="row row-bor" style="background:#F3F3F4;padding-bottom:15px;">
                            <!--<a href="javascript:void(0);" onclick="uniform_emp_close();" class="pull-right"> <i class="material-icons close" style="color:#E91E63; font-size:30px;opacity: 10;" data-toggle="tooltip" title="Close">close</i></a>-->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="ibox float-e-margins">
                                            <div class="ibox-title">
                                                ...
                                                <h5><b>Physics Text</b></h5>
                                                <!--<span class="label label-warning pull-right">Select</span>-->
                                                <span class="label label-warning pull-right">Add to list</span>
                                            ...
                                            <div class="ibox-content">
                                                ...
                                                <span class="label label-info ">Price:dhs 87</span>
                                                <!--<div class="stat-percent font-bold text-info">Price:DHS 20 </div>-->
                                                <div class="stat-percent font-bold text-danger">Item Code:XXXX </div>
                                                <span class="label label-danger pull-right">In Stock:40</span>
                                                <!--<large>5|2|2|2|2||6|9|6</large>-->
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class=" float-e-margins">
                                        <div class="">
                                            ...
                                            <div class="ibox-tools" id="add_type">
                                                <a data-toggle="modal" class="btn btn-primary btn-xs" data-toggle="tooltip" title="Invoice" data-placement="left" href="javascript:void(0)" onclick="uniform_show_invoice();">Generate Invoice</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    function uniform_filter_close() {
        var element = document.getElementById("filter_details");

        $('#filter_details').css("display", "none");
    }

    function uniform_show_invoice() {
        var ops_url = baseurl + 'uniform/substore/generate-invoice/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
