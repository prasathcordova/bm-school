                                ...
                                <div class="col-lg-12">
                                    <div class=" float-e-margins">
                                        <div class="">
                                            ...
                                            <div class="ibox-tools" id="add_type">
                                                <a data-toggle="modal" class="btn btn-primary btn-xs" data-toggle="tooltip" title="Invoice" data-placement="left" href="javascript:void(0)" onclick="uniform_show_invoice();">Generate Token</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
