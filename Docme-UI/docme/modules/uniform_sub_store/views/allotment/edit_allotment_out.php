            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools" id="add_type">
                        <span><a href="javascript:void(0);" data-toggle="tooltip" data-placement="right" title="Save order details" onclick="uniform_save_edit_allotment();"> <i style="font-size: 35px !important;  float: right;color: #23C6C5;" class="material-icons">save</i></a> </span>
                    </div>
                </div>
                                                                    ...
                                                                    <div class="col-lg-4 col-rt-pa-none">
                                                                        <div class="purchase-list">
                                                                            <div class="widget style1 " class="learn-more">
                                                                                <b> Item Code : <?php echo $item['item_code']; ?><a href="javascript:void(0);" onclick="uniform_select_item('<?php echo $item['itemsid']; ?>', '<?php echo $item['itemtype_name']; ?>', '<?php echo $item['item_code']; ?>', '<?php echo $item['barcode']; ?>', '<?php echo $item['selling_price']; ?>', '<?php echo $item['rate']; ?>', '<?php echo $item['stock'] ?>');" data-toggle="tooltip" data-placement="right" title="Move <?php echo $item['item_name']; ?> to selected items" data-original-title="<?php echo $item['item_name']; ?>" id="select"><i class="fa fa-paper-plane" style="font-size: 24px; color: #45aaaa; margin: 2%; float: right;"></i></a></b>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><a href="javascript:void(0);" onclick="uniform_deletedisplay('<?php echo $items['itemid'] ?>')" data-toggle="tooltip" data-placement="right" title="Discard item" data-original-title="" id="discard_<?php echo $items['itemid'] ?>"><i class="fa fa-times" style="font-size: 24px; color: #23C6C8; margin: 2%; "></i></a></td>
                                                                        </tr>
                                                                <?php
                                                                    }
                                                                }
...
<script type="text/javascript">
    ...
    function uniform_select_item(item_id, item_name, item_code, barcode, selling_price, rate, ava_stock) {
        //alert(selling_price);
        var flag = 0;
        if (rate == '') {
        ...
        if (flag == 1) {
            ...
            dTable.row.add([
                ...
                '<a href="javascript:void(0);" data-toggle="tooltip" data-placement="right" title="Confirm item" data-original-title="" id="confirm_' + item_id + '" onclick="uniform_valuedisplay(' + item_id + ')"><i class="fa fa-check" style="font-size: 24px; color: #23C6C8; margin: 2%; "></i></a> <a href="javascript:void(0);" onclick="uniform_deletedisplay(' + item_id + ')"   data-toggle="tooltip" data-placement="right" style="display: none" title="Discard item" data-original-title="" id="discard_' + item_id + '" ><i class="fa fa-times" style="font-size: 24px; color: #23C6C8; margin: 2%; "></i></a>'
    ...
    function uniform_valuedisplay(item_id) {
    ...
    function uniform_deletedisplay(item_id) {
        var discardid = '#discard_' + item_id;
    ...
    function uniform_save_edit_allotment() {
        ...
        var ops_url = baseurl + 'uniform/uniform/stock/allot-edit_out_save/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
