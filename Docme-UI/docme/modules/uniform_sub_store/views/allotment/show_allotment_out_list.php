            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools" id="add_type">
                        <a data-toggle="modal" class="btn btn-primary btn-xs" data-toggle="tooltip" title="Add new allotment" data-placement="left"  onclick="uniform_add_new_allotment_substore();"><i class="fa fa-plus"></i>ADD NEW ALLOTMENT</a>
                    </div>
                </div>
                                        ...
                                        if (isset($stockAllot_data) && !empty($stockAllot_data) && is_array($stockAllot_data)) {
                                            foreach ($stockAllot_data as $stockAllot) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <?php echo date('d-m-Y', strtotime($stockAllot['date'])); ?></td>
                                                    <td> <?php echo base64_decode($stockAllot['description']); ?></td>
                                                    <td> <?php echo $stockAllot['store_name']; ?></td>
                                                    <td align="right"> <?php echo $stockAllot['net_quantity']; ?></td>
                                                    <td> <?php echo $stockAllot['allotment_status']; ?></td>
                                                    <td>
                                                        <?php // if ($stockAllot['isapproved'] == NULL && $stockAllot['status_id'] == 7 || $stockAllot['status_id'] == 24 || $stockAllot['status_id'] == 23) { ?>
                                                            <!--<a href="javascript:void(0);" onclick="uniform_edit_allotment('<?php echo $stockAllot['masterid']; ?>', '<?php $stockAllot['description']; ?>', '<?php echo $stockAllot['storeid']; ?>', '<?php echo $stockAllot['net_quantity']; ?>', '<?php echo $stockAllot['net_price']; ?>');"  data-toggle="tooltip" data-placement="right" title="Edit Allotment <?php // echo $category['cate_name'];       ?>" data-original-title="<?php // echo $category['cate_name'];       ?>"  ><i class="fa fa-pencil" style="font-size: 24px; color: #23C6C8; margin: 2%; "></i></a>-->                                                       
                                                            <!--&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" onclick="uniform_discard_allotment('<?php echo $stockAllot['masterid']; ?>')"  data-toggle="tooltip" data-placement="right" title="Delete Allotment" data-original-title=""  ><i class="fa fa-times" style="font-size: 24px; color: #23C6C8; margin: 2%; "></i></a>-->                                                       
                                                                <?php // } else { ?>                                                 
                                                            &nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" onclick="uniform_view_allotment('<?php echo $stockAllot['masterid']; ?>');"  data-toggle="tooltip" data-placement="right" title="View Allotment Status" data-original-title="<?php // echo $category['cate_name'];       ?>"  ><i class="fa fa-file" style="font-size: 24px; color: #23C6C8; margin: 2%; "></i></a>   <?php // } ?> 
                                                    </td>
                                                </tr>
                                                <?php
                                            }
...
//NEW SCRIPT
//    function uniform_add_new_allotment_substore() {
...
//    }
     ...
     function uniform_add_new_allotment_substore() {
        var ops_url = baseurl + 'uniform/allotment/add-allotment_sub_out/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
...
//NEW SCRIPT
//    function uniform_edit_allotment() {
...
//    }
    ...
    function uniform_edit_allotment(allotment_id) {
        var ops_url = baseurl + 'uniform/stock/allot-edit_out/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function uniform_view_allotment(allotment_id) {
        var ops_url = baseurl + 'uniform/allotment/view-allotment_out/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
...
//    function uniform_view_allotment() {
...
//        });
//    }
    function uniform_approve_allotment(allotment_id) {
    ...
    function uniform_discard_allotment(allotment_id) {
