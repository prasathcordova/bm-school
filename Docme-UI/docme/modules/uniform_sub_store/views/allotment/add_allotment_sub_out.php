        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <span><a href="javascript:void(0);" onclick="uniform_submit_allotment();" data-toggle="tooltip" title="Save new stock allotment"> <i style="font-size: 30px !important; float: right; color: #23C6C8; padding-right: 10px;" class="material-icons">save</i></a> </span>
                    <!--</div>-->
                </div>
...
<script type="text/javascript">
    ...
    function uniform_submit_allotment() {
        ...
        var ops_url = baseurl + 'uniform/allotment/save-allotment_sub_out';
        swal({
            title: '',
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if (data.status == 1) {
                            ...
                            uniform_stock_allotment_Outword();
                        } else {
    ...
    function uniform_select_item(item_id, item_name, itemtype_name, item_code, barcode, selling_price, rate, stock) {
        //alert(selling_price);
        var flag = 0;
        if (rate == '') {
            var price = selling_price;
        ...
        if (flag == 1) {
            ...
            dTable.row.add([
                ...
                '<a href="javascript:void(0);" data-toggle="tooltip" data-placement="right" title="Confirm item" data-original-title="" id="confirm_' + item_id + '" onclick="uniform_valuedisplay(' + item_id + ',' + price + ',' + stock + ')"><i class="fa fa-check" style="font-size: 24px; color: #23C6C8; margin: 2%; "></i></a><a href="javascript:void(0);" onclick="uniform_deletedisplay(' + item_id + ')"   data-toggle="tooltip" data-placement="right" style="" title="Discard item" data-original-title="" id="discard_' + item_id + '" ><i class="fa fa-times" style="font-size: 24px; color: #23C6C8; margin: 2%; "></i></a>'
    ...
    function uniform_valuedisplay(item_id, price, stock) {
    ...
    function uniform_search_item() {
        ...
        var store_id = $("#store_id").val();
        var ops_url = baseurl + 'uniform/allotment/allotment-search_sub/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
