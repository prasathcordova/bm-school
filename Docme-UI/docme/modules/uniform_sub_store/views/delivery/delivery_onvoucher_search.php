                    ...
                    <div class="col-lg-4">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title" style="padding: 5PX 15PX 2px 15px;min-height: 35px;">
                                ...
                                <a href="javascript:void(0)" onclick="uniform_student_select_items('<?php echo $packlist['id']; ?>', '<?php echo $packlist['student_id']; ?>');">
...
<script>
    function uniform_student_select_items(packet_id, student_id) {
        uniform_bill_detail_delivery(student_id);
        uniform_select_items_delivery(packet_id);
    }
