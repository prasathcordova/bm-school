                                                ...
                                                <div class="contact-box center-version">                                                        
                                                    ...
                                                    <div class="contact-box-footer" style="padding: 5px 5px;">
                                                        <div class="m-t-xs btn-group">
                                                            <a href="javascript:void(0);" title="Deliver items to <?php echo $staff['Emp_Name'] ?>" onclick="uniform_delivery_faculty('<?php echo $staff['Emp_id']; ?>')" class="btn btn-xs btn-white"><i class="fa fa-user-plus"></i>Delivery</a>        
                                                        </div>
                                                    </div>
...
//         alert('ds');
    ...
    function uniform_delivery_faculty(Emp_id) {
//        var batchid = $('#batchid').val();
        var ops_url = baseurl + 'uniform/sales/substore-faculty-delivery/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
...
//                    $('#add_type').hide();
    ...
    function uniform_search_name() {
        ...
        var ops_url = baseurl + 'uniform/sales/search-teachername';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
