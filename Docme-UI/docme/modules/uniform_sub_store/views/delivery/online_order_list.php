                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php if ($data_c['payment_status'] == 1 &&  ($data_c['payment_details'] != '' || $data_c['payment_details'] != NULL)) { ?>
                                                                            <a target="_blank" href="<?php echo base_url() ?>uniform/substore/bill-print-duplicate/<?php echo $data_c['payment_details'] ?>" class=" btn btn-xs btn-info"><i class="fa fa-edit"></i>Print Bill</a>
...
<script type="text/javascript">
    ...
    function select_items_delivery(id, student_id) {
        var ops_url = baseurl + 'uniform/substore/online-delivery-pack-details';
        $('#add_type').show();
    ...
    function generate_bill(pack_id, student_id) {
        ...
        var ops_url = baseurl + 'uniform/substore/online-order-cod-process';
        $('#add_type').show();
        $("#item-replace-container").slideUp("slow", function() {
            $("#item-replace-container").hide();
        });
        $.ajax({
            ...
            success: function(result) {
                ...
                if (data.billcode) {
                    ...
                    var link = baseurl + 'uniform/substore/bill-print-other/' + data.billcode;
