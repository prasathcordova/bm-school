...
<div class="row">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            ...
            <a href="javascript:void(0)" onclick="uniform_delivery_student();" id="close_button" data-toggle="tooltip" title="Close" style="float: right; color: #B22222;"><i class="fa fa-close"></i></a>
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-line">
                            <div class="input-group"><input type="text" placeholder="Enter Student Name" id="sname" name="sname" class="form-control">
                                <span class="input-group-btn"> <button id="button_id_3" type="button" class="btn btn-primary" onclick="uniform_searchadvance_filtername();"><i class="fa fa-search"></i></button> </span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function uniform_search_name() {
        ...
        var ops_url = baseurl + 'uniform/sales/search-student-delivery';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function uniform_search_voucher() {
        ...
        var ops_url = baseurl + 'uniform/sales/search-voucher-delivery';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function uniform_searchadvance_filtername() {
        ...
        var ops_url = baseurl + '/uniform/delivery/advancesearch-studentname';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
