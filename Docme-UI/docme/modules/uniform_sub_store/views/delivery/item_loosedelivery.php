...
//dev_export($student_data['student_name']);die;
?>
<div class="ibox">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="ibox float-e-margins">
                                                ...
                                                <div class="ibox-title" style="padding: 5PX 15PX 2px 15px;min-height: 35px;">
                                                    <a href="javascript:void(0);"> <span class="label label-info pull-right" onclick="uniform_add_list('<?php echo $item['item_code'] ?>', '<?php echo $item['item_name'] ?>', '<?php echo $item['itemtype_name'] ?>', '<?php // echo $price 
                                                                                                                                                                                                                                                                        ?>', '<?php echo $item['itemsid'] ?>');">Ready for delivery</span></a>
            ...
            <div class="col-lg-12">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        ...
                        <a href="javascript:void(0);" onclick="uniform_submit_data();"> <i style="font-size: 27px !important; float: right; color: #ffffff; padding-right: 0px;" class="material-icons" data-toggle="tooltip" title="Save">save</i></a>
                    </div>
...
<script>
    function uniform_submit_data() {
        ...
        var ops_url = baseurl + 'uniform/substore/save-looseitem_issue/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
            ...
            success: function(result_stat) {
                try {
                    ...
                    console.log(data);
                    if (data.status == 1) {
                        swal('Success!!', 'Item for loose packing placed successfully', 'success');
                        load_classpacking();
    ...
    function uniform_add_list(item_code, item_name, itemtype_name, price, item_id) {
        ...
        if (flag == 1) {
            ...
            dTable.row.add([
                ...
                '<a href="javascript:void(0);" data-toggle="tooltip" data-placement="right" title="Confirm item" data-original-title="" id="confirm_' + item_id + '" onclick="uniform_valuedisplay(' + item_id + ',' + price + ')"><i class="fa fa-check" style="font-size: 24px; color: #23C6C8; margin: 2%; "></i></a> \n\  <span id="confirmed_' + item_id + '" style="display:none;" class="label label-warning pull-left" >confirmed</span> ',
                '<a href="javascript:void(0);"><span id="discard_' + item_id + '" class="label label-warning pull-left" onclick="uniform_deletedisplay(' + item_id + ', ' + price + ');" ><i class="fa fa-trash-o" aria-hidden="true"></i></span></a>'
    ...
    function uniform_valuedisplay(item_id, price) {
    ...
    function uniform_deletedisplay(item_id, price) {
        var discardid = '#discard_' + item_id;
