...
class Bill_model extends CI_model
{
    ...
    {
        $apikey = $this->session->userdata('API-Key');
        $user_data = transport_data_with_param_with_urlencode(array('action' => 'uniform_search_student_pack_billing', 'studentid' => $std_id, 'pack_data' => $searchpack), $apikey);
    ...
    public function cancel_bill($bill_masterid, $reason)
    {
        ...
        $status_data = transport_data_with_param_with_urlencode(array('action' => 'uniform_bill_cancel', 'bill_masterid' => $bill_masterid, 'reason' => $reason), $apikey);
    ...
    public function cancel_voucher($payment_id, $bill_masterid, $reason)
    {
        ...
        $status_data = transport_data_with_param_with_urlencode(array('action' => 'uniform_voucher_cancel', 'payment_id' => $payment_id, 'bill_masterid' => $bill_masterid, 'reason' => $reason), $apikey);
