...
class Sales_model extends CI_Model
{
    ...
    {
        $apikey = $this->session->userdata('API-Key');
        $data['action'] = 'uniform_get_stock_for_packing_substore';
    ...
    {
        $apikey = $this->session->userdata('API-Key');
        $data['action'] = 'uniform_get_student_pack';
        $data['studentid'] = $student_id;
    ...
    {
        $apikey = $this->session->userdata('API-Key');
        $data['action'] = 'uniform_bill_print_data';
    ...
    {
        $apikey = $this->session->userdata('API-Key');
        $data['action'] = 'uniform_studentpack_bill_select_oh';
    ...
    public function update_online_delivery_details($data)
    {
        ...
        $data['controller_function']   = 'sub_store_uniform/Billing_controller/update_online_delivery_details';
        $stud_packdetails = transport_data_with_param_with_urlencode($data, $apikey);
        return $stud_packdetails;
        if (is_array($stud_packdetails)) {
            return $stud_packdetails['data'];
    ...
    {
        $apikey = $this->session->userdata('API-Key');
        $data['action'] = 'uniform_get_payment_details';
        $data['pack_id'] = $pack_id;
        $stud_packdetails = transport_data_with_param_with_urlencode($data, $apikey);
        if (is_array($stud_packdetails)) {
            return $stud_packdetails['data'];
