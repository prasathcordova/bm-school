...
class Report_model extends CI_Model
{
    ...
    public function get_sale_return_report_all($startdate, $enddate, $store_id, $type)
    {
        $apikey = $this->session->userdata('API-Key');
        $data_prep = array(
            'action' => 'uniform_substore_sale_return_report',
            'storeid' => $store_id,
    ...
    public function get_sale_report_all($startdate, $enddate, $store_id)
    {
        $apikey = $this->session->userdata('API-Key');
        $data_prep = array(
            'action' => 'uniform_substore_sale_voucher_wise_report',
            'storeid' => $store_id,
            'start_date' => $startdate,
            'end_date' => $enddate
        );
    ...
    public function get_sale_itemwise_report_all($startdate, $enddate, $store_id, $type)
    {
        $apikey = $this->session->userdata('API-Key');
        $data_prep = array(
            'action' => 'uniform_substore_sale_item_wise_report',
            'storeid' => $store_id,
            'start_date' => $startdate,
            'end_date' => $enddate,
            'type' => $type
    ...
    public function get_sale_itemwise_summary_report_all($startdate, $enddate, $store_id, $type)
    {
        $apikey = $this->session->userdata('API-Key');
        $data_prep = array(
            'action' => 'uniform_substore_sale_item_wise_summary_report',
            'storeid' => $store_id,
            'start_date' => $startdate,
            'end_date' => $enddate,
            'type' => $type
    ...
    public function get_bbnd_report_all($startdate, $enddate, $store_id)
    {
        $apikey = $this->session->userdata('API-Key');
        $data_prep = array(
            'action' => 'uniform_substore_billed_but_not_delivered_item_wise_summary_report',
            'storeid' => $store_id,
            'start_date' => $startdate,
            'end_date' => $enddate
        );
    ...
    public function get_collection_report_all($startdate, $enddate, $store_id, $type = '')
    {
        $apikey = $this->session->userdata('API-Key');
        $data_prep = array(
            'action' => 'uniform_substore_collection_report',
            'storeid' => $store_id,
            'type' => $type,
            'start_date' => $startdate,
            'end_date' => $enddate
    ...
    public function get_collection_report_user_all($startdate, $enddate, $store_id)
    {
        $apikey = $this->session->userdata('API-Key');
        $data_prep = array(
            'action' => 'uniform_substore_collection_report_user_wise',
            'storeid' => $store_id,
            'start_date' => $startdate,
            'end_date' => $enddate
        );
    ...
    public function get_summary_collection_report_user_all($startdate, $enddate, $store_id)
    {
        $apikey = $this->session->userdata('API-Key');
        $data_prep = array(
            'action' => 'uniform_substore_summary_collection_report_user_wise',
            'storeid' => $store_id,
            'start_date' => $startdate,
            'end_date' => $enddate
        );
    ...
    public function get_stock_report_all($startdate, $enddate, $store_id)
    {
        $apikey = $this->session->userdata('API-Key');
        $data_prep = array(
            'action' => 'uniform_get_all_stock_report_data_substore',
            'store_id' => $store_id,
            'from_date' => $startdate,
            'to_date' => $enddate
        );
