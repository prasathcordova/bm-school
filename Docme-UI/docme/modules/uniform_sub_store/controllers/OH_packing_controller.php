...
class OH_packing_controller extends MX_Controller {
    ...
    public function search_openhouse_stud_view() {
        ...
        $oh_data = $this->OHPModel->uniform_get_oh_stud_assign_data_search($openhouse);
    ...
    public function openhouse_view() {
        ...
        $data['user_name'] = $this->session->userdata('user_name');
        $oh_data = $this->OHPModel->uniform_get_oh_stud_assign_data();
    ...
    public function openhouse_stud_list_view() {
        ...
        $oh_data = $this->OHPModel->uniform_get_student_openhouse($template_id, $openhouse_id);
