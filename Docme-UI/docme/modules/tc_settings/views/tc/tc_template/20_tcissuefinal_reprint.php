    ...
    <tr>
        <td style="padding: 0 10px;">
            ...
            <table class="tg" style="table-layout: fixed; width: 180mm;">
                ...
                <tr>
                    <th class="tg-k8iw">4. Identification marks <span style="text-align:right;padding-right:10px;">(i)</span>
                        <br>
                        <br>
                        <span style="text-align:right;padding-right:10px;">(ii)</span>
                    </th>
                    <th class="tg-jpc1">
            ...
            <table style="table-layout: fixed; width: 180mm;">
                <tr>
                    <td width="33.33%">
                        <span class="spn">Calicut</span><br />
