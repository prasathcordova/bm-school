                                    ...
                                    <div class="col-lg-4">
                                        <div class="ibox float-e-margins">
                                            ...
                                            <div class="ibox-title" style="padding: 5PX 15PX 2px 15px;">
                                                ...
                                                <!-- <span class="">Registration No &nbsp; <b><?php echo $busdata['vehicleNum']; ?></b> -->
                                            </div>
                                            <div class="ibox-content" style=" padding: 10px 15px 25px 15px;">
                                                ...
                                                <a>
                                                    <div class="stat-percent font-bold text-info pull-left" onclick="invoice_history('<?php echo $busdata['id']; ?>','<?php echo $busdata['vehicleNum']; ?>');" title="Invoice History"><i class="fa fa-stack-overflow" aria-hidden="true" style="padding:0 5px 0 0;"></i>Invoice History</div>
                                                </a>
...
<script type="text/javascript">
    ...
    function invoice_history(id, vehicleNum) {
        var bus_id = id;
