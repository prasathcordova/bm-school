...
<div class="wrapper wrapper-content animated fadeInRight" style="padding-top: 1px !important;padding-left: 0px !important;padding-right: 0px !important;">
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-xs-6" style="text-align: left;vertical-align:middle;margin-top:23px">
                                        <a href="javascript:void(0);" class="btn btn-primary btn-sm " onclick="generate_qrcode();"> Generate</a>
    ...
    <script type="text/javascript">
        ...
        function generate_qrcode() {
            ...
            var reg_no = $('#vehicle_select option:selected').text();
            if(vehicle_id == -1){
                swal('', 'Select a vehicle.', 'info');
            }else{
                var ops_url = baseurl + 'transport/vehicle-qrcode-generate';
                $.ajax({
                    type: "POST",
                    cache: false,
                    async: false,
