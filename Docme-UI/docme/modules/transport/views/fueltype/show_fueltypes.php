            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title" style="border-bottom-color:#23C6C8!important">
                    ...
                    <div class="ibox-tools" id="add_type">
                        <!--<a data-toggle="modal" class="btn btn-primary btn-xs" data-toggle="tooltip" title="Add a Fee Type" data-placement="left"href="javascript:void(0)" onclick="add_new_fee_type();"><i class="fa fa-plus"></i>ADD NEW INSURANCE</a>-->
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <table id="insurance_tbl" style="width:100%">
                                    <?php
                                    $breaker = 0;
                                    if (isset($vehicle_fueltype_data) && !empty($vehicle_fueltype_data)) {
                                        foreach ($vehicle_fueltype_data as $fueltype) {
                                    ?>
                                            <tr>
                                                <td>
                                                            ...
                                                            <div class="chat-activity-list">
                                                                <div class="chat-element">
                                                                    <div class="media-body ">
                                                                        <p>
                                                                            <!--<a href="javascript:void(0);" onclick="edit_fee_type('<?php echo $fueltype['id']; ?>', '<?php echo $fueltype['fuelTypeName']; ?>');"  data-toggle="tooltip" data-placement="right" title="Edit <?php echo $fueltype['fuelTypeName']; ?>" data-original-title="<?php echo $fueltype['fuelTypeName']; ?>"  > <small class="pull-right text-navy">Edit</small></a>-->
                                                                            <strong>Fuel Type :</strong>
                                                                            <?php echo $fueltype['fuelTypeName']; ?>
                                                                        </p>

                                                                        <small class="text-muted">created On : &nbsp;&nbsp;&nbsp;<?php echo  date('d-m-Y', strtotime($fueltype['createdOn'])) ?></small>

                                                                        <div class="switch  pull-right">
                                                                            <div class="onoffswitch">
                                                                                <?php if ($fueltype['isActive'] == 1) { ?>
                                                                                    <input type="checkbox" checked class="onoffswitch-checkbox fee_type_status" data-feetypeid="<?php echo $fueltype['id']; ?>" id="fee_type_<?php echo $fueltype['id']; ?>">
                                                                                    <label class="onoffswitch-label" for="fee_type_<?php echo $fueltype['id']; ?>">
                                                                                        <span class="onoffswitch-inner"></span>
                                                                                        <span class="onoffswitch-switch"></span>
                                                                                    </label>
                                                                                <?php } else { ?>
                                                                                    <input type="checkbox" class="onoffswitch-checkbox fee_type_status" data-feetypeid="<?php echo $fueltype['id']; ?>" id="fee_type_<?php echo $fueltype['id']; ?>">
                                                                                    <label class="onoffswitch-label" for="fee_type_<?php echo $fueltype['id']; ?>">
                                                                                        <span class="onoffswitch-inner"></span>
                                                                                        <span class="onoffswitch-switch"></span>
                                                                                    </label>
...
<script type="text/javascript">
    ...
    function change_status(element) {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                if (data.status == 1) {
                    if (status == -1) {
                        swal('Fuel type updated', 'Fuel type deactivated successfully.', 'success');
                        $('#faculty_loader').removeClass('sk-loading');
                        return true;
                    } else {
                        if (status == 1) {
                            swal('Fuel type updated', 'Fuel type activated successfully.', 'success');
                            $('#faculty_loader').removeClass('sk-loading');
                            return true;
                        }
                    }
                    ...
                    if (data.status == 0) {
                        ...
                        if (data.status == 3) {
                            ...
                            swal({
                                title: '',
                                text: 'Fuel type status updation failed.',
                                type: 'info',
                                showCancelButton: false,
                                confirmButtonColor: '#3085d6',
                                cancelButtonColor: '#d33',
    ...
    function submit_data() {
        ...
        if (fee_type_name_new == '') {
            ...
            swal('', 'Fee type should contain letters or numbers 2 to 10.', 'info');
            $('#faculty_loader').removeClass('sk-loading');
            return false;
        }
    ...
    function submit_edit_save_data() {
        $('#faculty_loader').addClass('sk-loading');
        var fee_type_name_new = $('#makeName').val();
