            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title" style="border-bottom-color:#ffd300 !important;">
                    ...
                    <div class="ibox-tools" id="add_type">
                        <a data-toggle="modal" class="btn btn-primary btn-xs" data-toggle="tooltip" title="Add a Fee Type" data-placement="left" href="javascript:void(0)" onclick="add_new_vehicle_model();"><i class="fa fa-plus"></i>ADD VEHICLE MODEL</a>
                    </div>
                </div>
                                                            ...
                                                            <div class="chat-activity-list">
                                                                <div class="chat-element">
                                                                    <div class="media-body ">
                                                                        ...
                                                                        <small class="text-muted">Created On : &nbsp;&nbsp;&nbsp;<?php echo  date('d-m-Y', strtotime($vehicle_model['createdOn'])) ?></small>
...
<script type="text/javascript">
    ...
    function submit_data() {
        ...
        if (vehicle_model == '') {
            ...
            $('#faculty_loader').removeClass('sk-loading');
            return false;
        } else if ((vehicle_model.length > '10') || (vehicle_model.length < '2')) {
            swal('', 'Vehicle Model should contain letters or numbers 2 to 10.', 'info');
            $('#faculty_loader').removeClass('sk-loading');
            return false;
        }
    ...
    function submit_edit_save_data() {
        ...
        $.ajax({
            ...
            success: function(result) {
                var data = $.parseJSON(result);
                if (data.status == 1) {
                    swal('Success', 'Vehicle Model, ' + vehicle_model + ' modified successfully.', 'success');
