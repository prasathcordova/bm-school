        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                ?> "> 
                    ...
                    <input type="text" maxlength="10" class="form-control "  name="vehicle_model" id="vehicle_model" value="<?php echo set_value('modelName', isset($model_data['model_name']) ? $model_data['model_name'] : ''); ?>" />
                </div>                           
            </div>
        </div>
