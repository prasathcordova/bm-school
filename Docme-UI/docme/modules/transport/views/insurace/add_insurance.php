<div class="row clearfix" style="padding-bottom: 60px;">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body"> 
                <?php
                echo form_open('', array('id' => 'insurance_save', 'role' => 'form'));
                ?>
                ...
                <div class="row clearfix">
                    <div class="col-md-6">                    
                        ...
                        <div class="form-group">
                            ...
                            if (form_error('insurance_cmpny')) {
                                echo 'has-error';
                            }
                            ?> ">
                                <input type="text" maxlength="50" placeholder="Insurance Company Name" class="form-control" name="insurance_cmpny" id="insurance_cmpny" value="<?php echo set_value('insurance_cmpny', isset($insurance_cmpny) ? $insurance_cmpny : ''); ?>" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">                     
                        ...
                        <div class="form-group">
                            ...
                            ?> ">
                                <input type="text" maxlength="100" placeholder="Description" class="form-control" name="description" id="description" value="<?php echo set_value('description', isset($description) ? $description : ''); ?>" />
                            </div>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
