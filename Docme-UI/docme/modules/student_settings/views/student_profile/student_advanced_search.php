<div class="row" id="">
    <div class="panel panel-info">
        <div class="panel-heading">
            <i class="fa fa-info-circle"></i>Batch Filter
        ...
        <div class="panel-body">
            ...
            <div class="row" id="admission_div">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <div class="input-group"><input type="text" id="admission_no" name="admission_no" placeholder="Enter Admission Number" class="form-control"> <span class="input-group-btn">
                                    <button type="button" id="search_name_btn" class="btn btn-primary" onclick="search_admission_no();"><i class="fa fa-search"></i> </button> </span>
                            </div>
                        </div>
                    </div>
            ...
            <div id="advanced_search" class="row">
                ...
                <div class="col-lg-6 col-xs-12 col-md-12">
                    ...
                    <div class="form-group">
                        <div>
                            <select class="select2_registration form-control" style="width:100% !important" id="batch_id" name="batch_id">
                                <?php
...
<script type="text/javascript">
    ...
    function search_admission_no() {
        ...
        //                                            var ops_url = baseurl + 'bill/search-studentname';
        var ops_url = baseurl + 'advanced_search/admn_no_search';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function searchadvance_filtername() {
        ...
        var ops_url = baseurl + 'student/advancesearch-studentname';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
