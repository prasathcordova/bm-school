                                            ...
                                            <div class="contact-box-footer">
                                                <div class="m-t-xs btn-group">
                                                    <?php if (check_permission(503, 1096, 102)) { ?>
                                                        ...
                                                        <!--a href="javascript:void(0);" onclick="send_personal_email('<?php echo $student['student_id']; ?>', '<?php echo $student['Cur_AcadYr']; ?>', '<?php echo $student['Cur_Batch']; ?>','<?php echo $student['Cur_Class']; ?>','<?php echo $student['student_name']; ?>','<?php echo $student['Batch_Name']; ?>','<?php echo $student['Admn_No'] ?>')" class="btn btn-xs btn-white " title="Email"><i class="fa fa-envelope"></i> Email</a-->
                                                    <?php }
