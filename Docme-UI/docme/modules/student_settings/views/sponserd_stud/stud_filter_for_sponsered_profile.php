                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="text-center">
                                                                <div class="m-t-xs btn-group" style="">
...
<script type="text/javascript">
    ...
    function search_admn_no() { //search_name()
        ...
        var ops_url = baseurl + 'profile/search-admission-no-for-sponsered_stud';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function searchbyname() {
        ...
        var ops_url = baseurl + 'profile/search-name-for-sponsered_stud';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function load_students_after_filter(courseid) {
        ...
        var ops_url = baseurl + 'profile/show-profile-for_sponsered_stud';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
