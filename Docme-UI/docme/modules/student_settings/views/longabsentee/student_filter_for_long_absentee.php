                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <div class="input-group"><input type="text" id="searchname" name="searchname" placeholder="Search student by Admission Number/Name" class="form-control" autofocus="">
                                                    <span class="input-group-btn">
                                                        <button class="btn btn-sm btn-primary" onclick="search_name()" title="Search"><i style="font-size:17px;" class="material-icons">search</i></button>
...
<script>
    ...
    function search_name() {
        ...
        $.ajax({
            ...
            //data: {"load": 1, "searchdata": searchname},
