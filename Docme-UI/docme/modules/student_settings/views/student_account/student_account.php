                ...
                <div class="ibox-content" id="pay_loader">
                    ...
                    <div class="wrapper wrapper-content animated fadeInRight" id="student-data-container">
                        <div class="row">
                            ...
                            <div class="col-md-7" style="padding-top:5px; float: right;">
                    ...
                    <div class="row">
                        ...
                        <div class="clearfix"></div>
                        <?php
                        if (strcmp(strtoupper(trim($student_data['StatusFlag'])), 'L') != 0) {
                        ?>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ibox float-e-margins">
                                            ...
                                            <div class="form-group col-lg-6 col-xs-12 col-md-12">
                                                <div class="form-group" id="data_1">
                                                    ...
                                                    <div class="input-group date">
                                                        ...
                                                        <input type="text" id="feedisable_date" name="feedisable_date" readonly="" placeholder=" Fee Disable Date" class="form-control nofocusitem" value="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group col-lg-6 col-xs-12 col-md-12">
                                                <div class="form-group" id="data_1">
                                                    ...
                                                    <div class="input-group date">
                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" id="lastattend_date" name="lastattend_date" readonly="" placeholder=" Last Date of Attendance" class="form-control" value="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <!-- function parameter added by vinoth @ 14-05-2019 2:00 -->
                                                <button type="button" class="btn btn-info btn-sm" onclick="longabsentee('<?php echo $student_data['Batch_Name']; ?>','<?php echo $student_data['student_id']; ?>', '<?php echo $student_data['Admn_NO']; ?>', '<?php echo $student_data['Cur_AcadYr']; ?>', '<?php echo $student_data['Class_ID']; ?>', '<?php echo $student_data['student_name']; ?>');" title="Mark as Long Absentee">Mark as Long Absentee</button>
                                            </div>
                        ...
                        <?php
                            $feeenable_date = '';
                        } else if (strcmp(strtoupper(trim($student_data['StatusFlag'])), 'L') == 0) {
                            $feeenable_date = $student_data['fee_disable_from'];
                        ?>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-content ">
                                        <div class="row">
                                            <div class="form-group col-lg-6 col-xs-12 col-md-12">
                                                <div class="form-group" id="data_1">
                                                    ...
                                                    <div class="input-group date">
                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                        <input type="text" id="feeenable_date" name="feeenable_date" placeholder="Fee Enable Date" class="form-control nofocusitem" readonly="" value="<?php echo date('d-m-Y'); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                                            <div class="col-lg-12 col-md-4 col-sm-6 col-xs-12">
                                                <!-- function parameter added by vinoth @ 14-05-2019 2:00 -->
                                                <!-- <button style="margin-left: 30px;" type="button" class="btn btn-info btn-sm" onclick="longabsentee('<?php echo $student_data['Batch_Name']; ?>','<?php echo $student_data['student_id']; ?>', '<?php echo $student_data['Admn_NO']; ?>', '<?php echo $student_data['Cur_AcadYr']; ?>', '<?php echo $student_data['Class_ID']; ?>', '<?php echo $student_data['student_name']; ?>');" title="Mark as Long Absentee">Mark as Long Absentee</button> -->
                                                <!-- <button class="btn btn-info btn-xl" type="button" onclick="load_students_after_filter('<?php echo $student_data['Cur_Batch']; ?>', '<?php echo $student_data['Cur_AcadYr']; ?>','<?php echo $student_data['Class_ID']; ?>')" title="Long Absentee Release">Long Absentee Release </button> -->
                                                <button class="btn btn-info btn-sm" type="button" onclick="longabbsentrelease('<?php echo $student_data['student_id']; ?>', '<?php echo $student_data['student_name']; ?>', '<?php echo $student_data['admission_date'] ?>', '<?php echo $student_data['Cur_Batch'] ?>', '<?php echo $student_data['Cur_AcadYr'] ?>', '<?php echo $student_data['Class_ID'] ?>', event)" title="Long Absentee Release">Release Long Absentee </button>
                                                <!-- <button class="btn btn-info btn-xl" type="button" onclick="longabbsentrelease('<?php echo  $student_data['student_id']; ?>', '<?php echo  $student_data['student_name']; ?>', '<?php echo  $student_data['admission_date'] ?>', event)" title="Long Absent Release">Long Absent Release </button> -->
                                                <button class="btn btn-info btn-sm" type="button" onclick="back_to_list('<?php echo $student_data['Cur_Batch']; ?>', '<?php echo $student_data['Cur_AcadYr']; ?>','<?php echo $student_data['Class_ID']; ?>')" title="back to List">Back to Long Absentee List</button>
                                            </div>
                        ...
                        <input type="hidden" name="cheque_non_recon" id="cheque_non_recon" value="<?php echo $cheque_non_reconcile_transaction; ?>" />
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <div class="info-box bg-green hover-expand-effect hover-zoom-effect">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="number"><?php echo my_money_format($total_demand_paid_amount + $penalty_amount); ?></div><!-- + $PAID_DATA-->
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                ...
                                                                <table class="table table-striped table-bordered table-hover dataTables-example" id="tbl_fee_demand_statement" style="padding-bottom: 0px !important;padding-top: 10px !important;width: 98%">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <!-- <th>Penalty</th> -->
                                                                            <th>Paid Status</th>
                                                                            <th class="text-center">Partial Paid <small>(if any)</small></th>
                                                                            <th>Concession</th>
                                                                            <th>Exemption</th>
                                                                            <th>Exemption Pending</th>
                                                                            <th>Reconc. Pending</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        //    console.log(moment('<?php echo $student_data['admission_date']; ?>', 'YYYY-MM-DD').format('YYYY-MM-DD'));
        ...
        $('#feeenable_date').datepicker({
            ...
            autoclose: true,
            format: 'dd-mm-yyyy',
            startDate: '<?php echo date('d/m/Y', strtotime($feeenable_date)); ?>',
            // endDate: '+0d'
            endDate: '<?php echo date('d/m/Y', strtotime($acdenddate)); ?>'
        });
        ...
        // $('#feedisable_date, #lastattend_date').datepicker('setDate', moment(new Date(), 'YYYY-MM-DD').format('YYYY-MM-DD'));
        //written by Elavarasan S @ 15.05.2019 6:41
        // $('#feedisable_date, #lastattend_date').datepicker('setStartDate', moment('<?php echo $student_data['admission_date']; ?>', 'YYYY-MM-DD').format('YYYY-MM-DD'));
    });
    Morris.Donut({
    ...
    function back_to_list(batch_id, acd_year, course_id) {
        load_students_after_filter(batch_id, acd_year, course_id);
    }

    // function lonng_absentee_release(student_id, student_name, adm_date, curbatch, curacdyear, curclass, event) {
    //     release_from_account_page(student_id, student_name, adm_date, curbatch, curacdyear, curclass, event);
    // }

    function refresh_student_account(studentid, studentname, batchid) {
        var ops_url = baseurl + 'profile/student_account_reload';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function profile_detail(studentid, batchid) {
    ...
    function longabsentee(batch_name, student_id, Admn_NO, Cur_AcadYr, Class_ID, student_name) {
        //        this condition write by vinoth 14-may-19 16:56 
        if (batch_name == '') {
            swal('', 'Batch not assigned students cannot be marked as long absentee', 'info');
            return false;
        } else {
            var date1 = $("#feedisable_date").val();
            // alert(moment($('#feedisable_date').val(), "DD-MM-YYYY").format('YYYY-MM-DD'));
            // return false;
            var date2 = $("#lastattend_date").val();
            if (date1 == '') {
                swal('', 'Select a Fee Disable Date', 'info');
            }
            if (date2 == '') {
                swal('', 'Select Last Date of Attendance', 'info');
            }

            if (moment($('#feedisable_date').val(), "DD-MM-YYYY").isValid() == false) {
                //change messgae name by vinoth @28-05-2019 16:03
                swal('', 'Select a Fee Disable Date', 'info');
                return false;
            }
            if (moment($('#lastattend_date').val(), "DD-MM-YYYY").isValid() == false) {
                //change message name by vinoth @ 28-05-2019 15:00
                swal('', 'Select a Last Date of Attendance', 'info');
                return false;
            }
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (data.status == 1) {
                        ...
                        //refresh_student_account(student_id, student_name, $('#batch_id').val());
                        profile_detail(student_id, $('#batch_id').val());
                        return false;
                    } else {
                        if (data.message) {
                            swal('', data.message, 'info');
    ...
    function longabbsentrelease(student_id, student_name, adm_date, curbatch, curacdyear, curclass, event) {
        var lb_en_data = moment($('#feeenable_date').datepicker('getDate')).format('YYYY-MM-DD');
