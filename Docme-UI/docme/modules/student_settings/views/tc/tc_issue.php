                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-lg-6 col-xs-12 col-md-12" style="margin-bottom:25px;">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="order_id" name="order_id" value="" placeholder="" class="form-control" disabled="" style="background-color: white">
                                        </div>
                                    </div>
                                </div>
                                <div class="row" style="margin-top: -5px !important">
                                    <div class="col-lg-6 col-xs-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="customer" name="customer" value="" placeholder="2010-11" class="form-control" disabled="" style="background-color: white">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-xs-12 col-md-12">
                                        <div class="form-group">
                                            <label class="control-label" for="customer">Last Date of Attendance :</label>
                                            <input type="text" id="customer" name="customer" value="" placeholder="03/04/2014" class="form-control" disabled="" style="background-color: white">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-xs-12 col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-6 col-xs-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="customer" name="customer" value="" placeholder="Good" class="form-control" disabled="" style="background-color: white">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-xs-12 col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-6 col-xs-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="customer" name="customer" value="" placeholder="6" class="form-control" disabled="" style="background-color: white">
                                        </div>
                                    </div>
                                </div>
                            </div>
