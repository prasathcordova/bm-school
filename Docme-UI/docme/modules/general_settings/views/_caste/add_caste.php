...
//                                                 dev_export($community);die;
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            ?> "> 
                                <input type="text" class="form-control text-uppercase" placeholder="Enter Caste Name" name="caste_name" id="caste_name" value="<?php echo set_value('caste_name', isset($caste_name)?$caste_name:'');  ?>" maxlength="50" />
                            </div>                           
                        </div>
                    </div>
