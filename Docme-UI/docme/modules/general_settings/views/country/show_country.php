                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <!--<td> <span class="badge badge-info"><?php echo $country['country_name']; ?></span></td>-->
                                                    <td> <?php echo $country['country_abbr']; ?></td>
                                                    <!--<td> <span class="badge badge-danger"style="background-color:hotpink!important;color:white!important;"><?php echo $country['country_abbr']; ?></span></td>-->
                                                    <!--<td> <span class="badge badge-success"><?php echo $country['country_nation']; ?></span></td>-->
                                                    ...
                                                    <div class="switch">
                                                        <div class="onoffswitch">
                                                            ...
                                                            onchange="change_status('<?php echo $country['country_id']; ?>',  this)" 
                                                            id="<?php echo $country['country_id']; ?>">
                                                            <label class="onoffswitch-label" for="<?php echo $country['country_id']; ?>">
...
<script type="text/javascript">
    ...
    function submit_data() {
        ...
        if (country_name == '') {
            ...
            swal('', 'Country Name should contain 3 to 30 Characters', 'info');
            $('#faculty_loader').removeClass('sk-loading');
            return false;
        }
        ...
        if (country_abbr == '') {
            ...
            swal('', 'Country Abbreviation should contain 2 to 15 Characters', 'info');
            $('#faculty_loader').removeClass('sk-loading');
            return false;
        }
        ...
        if (country_nation == '') {
            ...
            swal('', 'Nationality should contain 3 to 30 Characters', 'info');
            $('#faculty_loader').removeClass('sk-loading');
            return false;
        }
        var alphanumers = /^[a-zA-Z\s]+$/;
