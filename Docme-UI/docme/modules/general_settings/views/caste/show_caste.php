                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td data-toggle="tooltip" title="Slide for Enable/Disable">
                                                        <div class="switch">
                                                            <div class="onoffswitch">
                                                                ...
                                                                <input type="checkbox" <?php echo $checked ?> class="onoffswitch-checkbox pick_status" onchange="change_status('<?php echo $caste['caste_id'] ?>','<?php echo $caste['community_id']; ?>', this)" id="<?php echo $caste['caste_id']; ?>">
                                                                <label class="onoffswitch-label" for="<?php echo $caste['caste_id']; ?>">
                                                    ...
                                                    <td>
                                                        <a href="javascript:void(0)" class="btn btn-xs btn-info" onclick="edit_caste('<?php echo $caste['caste_id']; ?>', '<?php echo $caste['caste_name']; ?>', '<?php echo $caste['religion_name']; ?>', '<?php echo $caste['community_name']; ?>');" data-toggle="tooltip" data-placement="right" title="Edit <?php echo $caste['caste_name']; ?>" data-original-title="<?php echo $caste['caste_name']; ?>"><i class="fa fa-edit"></i>Update</a>
                                                    </td>
                                                </tr>
                                        <?php
                                            }
