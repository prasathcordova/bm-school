        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <div class="title-action" style="text-align: right;padding-top: 0px; padding-bottom: 10px;">
                    ...
                    ?>
                    <a href="javascript:void(0)" id="submit_id" onclick="submit_data('<?php echo $details_data[0]['id']; ?>', '<?php echo $details_data[0]['delivery_number']; ?>')" class="btn btn-primary"> Confirm Delivery Return </a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($items['is_delivered'] == 1) { ?>
                                                ...
                                                ?>
                                                        <a href="javascript:void(0)" onclick="return_item('<?php echo $items['item_id'] ?>', '<?php echo $price ?>', '<?php echo $items['type_id'] ?>', '<?php echo $items['quantity'] ?>', '<?php echo $items['returnable_qty'] ?>', '<?php echo $items['stock_qty']; ?>', '<?php echo $items['tax_percent']; ?>', '<?php echo $items['tax_type']; ?>');" id="return_id<?php echo $items['item_id'] ?>" data-toggle="tooltip" title="Return Item"><i class="fa fa-check" style="font-size: 24px; color: #23C6C8; margin: 2%; "></i></a>
...
<script>
    ...
    function return_item(item_id, price, type_id, qty, delivery_qty, available_qty, tax_percent, tax_type) {
        $('#saving_values').show();
    ...
    function submit_data(delivery_id, delivery_number) {
        ...
        var ops_url = baseurl + 'delivery/faculty_deliveryReturn-save/';
        swal({
            title: "Are you sure?",
