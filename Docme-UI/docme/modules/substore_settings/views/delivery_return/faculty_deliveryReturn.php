                    ...
                    <div class="panel-body">
                        <div class=" input-group" style="padding-bottom: 5%;">
                            ...
                            <span class="input-group-btn">
                                <button type="button" id="button_id" class="btn btn btn-primary" onclick="search_faculty_delivery_return();"> <i class="fa fa-search"></i></button>
                                            ...
                                            <div class="ibox float-e-margins">
                                                <div class="ibox-title" style="padding: 5PX 15PX 2px 15px;min-height: 35px;">
                                                    ...
                                                    <?php if ($packlist['is_return'] != 1) { ?>
                                                        <a href="javascript:void(0)" onclick="select_items('<?php echo $packlist['id']; ?>');">
...
<script>
    ...
    function select_items(id) {
        ...
        var ops_url = baseurl + 'substore/faculty-deliveryReturn-pack-details';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function search_faculty_delivery_return() {
        $('#item-replace-container').html('');
        $('#item-data-container').html('');
        var searchvoucher = $("#searchitem").val();
        var emp_id = $("#emp_id").val();

        var ops_url = baseurl + 'sales/faculty-voucher-deliveryretn';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
