                    ...
                    <div class="panel-body">
                        <div class=" input-group" style="padding-bottom: 5%;">
                            ...
                            <span class="input-group-btn">
                                <button type="button" id="button_id" class="btn btn btn-primary" onclick="search_item('<?php echo $student_id; ?>');"> <i class="fa fa-search"></i></button>
                                            ...
                                            <div class="ibox float-e-margins">
                                                <div class="ibox-title" style="padding: 5PX 15PX 2px 15px;min-height: 35px;">
                                                    ...
                                                    <?php if ($packlist['is_return'] != 1 && $packlist['is_partial_payment'] == 0  && $packlist['is_payment_done'] == 1) { ?>
                                                        <a href="javascript:void(0)" onclick="select_items('<?php echo $packlist['id']; ?>');"><span class="label label-info pull-right" style="background-color: #0070A0;">For Delivery Return</span>
                                                        </a>
                                                    <?php } else if ($packlist['is_partial_payment'] == 1 && $packlist['is_payment_done'] == 0 && $packlist['is_return'] != 1) { ?>
                                                        <a href="javascript:void(0)" onclick="select_items('<?php echo $packlist['id']; ?>');"><span class="label label-danger pull-right">Partial Paymet</span> </a>
                                                    <?php } else { ?>
                                                        <a href="javascript:void(0)" onclick="select_items('<?php echo $packlist['id']; ?>');"> <span class="label label-info pull-right">Delivery Returned </span>
                                                        </a>
                                                    <?php } ?>
                                                </div>
                                                <div class="ibox-title" style="padding: 5PX 15PX 2px 15px;min-height: 35px;">
...
<script>
    ...
    function select_items(id) {
        ...
        var ops_url = baseurl + 'substore/deliveryReturn-pack-details';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function search_item(student_id) {
        ...
        var ops_url = baseurl + 'sales/searchstud-voucher-deliveryretn';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
