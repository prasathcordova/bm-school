            ...
            <div class="panel-body">
                <div class="title-action" style="text-align: right;padding-top: 0px; padding-bottom: 10px;">
                    ...
                    <?php if ($details_data[0]['type'] == 3) { ?>
                        <a href="javascript:void(0)" id="OH_return" onclick="submit_data_OH('<?php echo $details_data[0]['id']; ?>', '<?php echo $details_data[0]['delivery_number']; ?>')" class="btn btn-primary"> Confirm OH Return </a>
                    <?php } else { ?>
                        <a href="javascript:void(0)" id="submit_return" onclick="submit_data('<?php echo $details_data[0]['id']; ?>', '<?php echo $details_data[0]['delivery_number']; ?>')" class="btn btn-primary"> Confirm Delivery Return </a>
                    <?php } ?>
                                            ...
                                            <?php } else { ?>
                                                <?php if ($items['is_delivered'] == 1) { ?>
                                                    <?php if ($items['returnable_qty'] != 0 || $items['returnable_qty'] > 0) { ?>
                                                        <a href="javascript:void(0)" onclick="return_item('<?php echo $items['del_detail_id'] ?>', '<?php echo $items['item_id'] ?>', '<?php echo $price ?>', '<?php echo $items['type_id'] ?>', '<?php echo $items['quantity'] ?>', '<?php echo $items['returnable_qty'] ?>', '<?php echo $items['stock_qty']; ?>', '<?php echo $items['tax_percent']; ?>', '<?php echo $items['tax_type']; ?>');" id="return_id<?php echo $items['item_id'] ?>_<?php echo $items['del_detail_id'] ?>" data-toggle="tooltip" title="Return Item"><i class="fa fa-check" style="font-size:20px;color: #24c6c8;"></i></a>
...
<script>
    ...
    function return_item(del_detail_id, item_id, price, type_id, qty, delivery_qty, available_qty, tax_percent, tax_type) {
    ...
    function submit_data(delivery_id, delivery_number) {
        ...
        var ops_url = baseurl + 'delivery/deliveryReturn-save/';
        swal({
            title: "Are you sure?",
    ...
    function submit_data_OH(delivery_id, delivery_number) {
        ...
        var ops_url = baseurl + 'delivery/deliveryOHReturn-save/';
        swal({
            title: "Are you sure?",
            text: "Do you want to return the quantities of Delivery : " + delivery_number + " ?",
            type: "warning",
