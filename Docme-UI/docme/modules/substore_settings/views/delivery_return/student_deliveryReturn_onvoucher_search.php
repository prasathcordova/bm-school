                        ...
                        <div class="col-lg-4">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title" style="padding: 5PX 15PX 2px 15px;min-height: 35px;">
                                    ...
                                    <a href="javascript:void(0)" onclick="select_items_delivery_return('<?php echo $packlist['id']; ?>', '<?php echo $packlist['student_id']; ?>');">
...
<script>
    function select_items_delivery_return(packid, student_id) {
        bill_detail(student_id);
        select_items(packid);
    }
    ...
    function bill_detail(studentid) {
        var batchid = $('#batchid').val();
        var ops_url = baseurl + 'delivery/show-deliveryreturn/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
