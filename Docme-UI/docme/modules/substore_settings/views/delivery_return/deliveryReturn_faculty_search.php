                                                ...
                                                <div class="contact-box center-version">                                                        
                                                    ...
                                                    <div class="contact-box-footer" style="padding: 5px 5px;">
                                                        <div class="m-t-xs btn-group">
                                                            <a href="javascript:void(0);" title="Delivery return <?php echo $staff['Emp_Name'] ?>" onclick="delivery_return_faculty('<?php echo $staff['Emp_id']; ?>')" class="btn btn-xs btn-white"><i class="fa fa-user-plus"></i>Delivery return</a>        
                                                        </div>
                                                    </div>
...
//         alert('ds');
    ...
    function delivery_return_faculty(Emp_id) {
//        var batchid = $('#batchid').val();
        var ops_url = baseurl + 'delivery/show-faculty_deliveryreturn/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
...
//                    $('#add_type').hide();
    ...
    function search_name() {
        ...
        var ops_url = baseurl + 'delivery/search-teachername';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
