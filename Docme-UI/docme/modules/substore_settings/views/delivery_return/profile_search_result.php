                    ...
                    <div class="contact-box center-version">
                        ...
                        <div class="contact-box-footer">
                            <div class="m-t-xs btn-group">
                                <a href="javascript:void(0);" title="Delivery return - <?php echo $student['student_name'] ?>" onclick="bill_detail('<?php echo $student['student_id']; ?>')" class="btn btn-xs btn-white"><i class="fa fa-user-plus"></i> Delivery Return</a>
                            </div>
                        </div>
