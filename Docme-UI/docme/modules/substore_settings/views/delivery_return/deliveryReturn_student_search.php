...
<div class="row">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            ...
            <a href="javascript:void(0)" onclick="deliveryreturn();" id="close_button" data-toggle="tooltip" title="Close" style="float: right; color: #B22222;"><i class="fa fa-close"></i></a>
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-line">
                            <div class="input-group"><input type="text" placeholder="Enter Student Name" id="sname" name="sname" class="form-control">
                                <span class="input-group-btn"> <button id="button_id_3" type="button" class="btn btn-primary" onclick="searchadvance_filtername();"> <i class="fa fa-search"></i>
                                    </button> </span></div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function search_name() {
        ...
        var ops_url = baseurl + 'sales/search-student-deliveryReturn';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function search_voucher() {
        ...
        var ops_url = baseurl + 'sales/search-voucher-deliveryReturn';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function searchadvance_filtername() {
        ...
        var ops_url = baseurl + 'deliveryrtn/advancesearch-studentname';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
