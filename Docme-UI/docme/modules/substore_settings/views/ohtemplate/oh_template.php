            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools" id="add_type">
                        <?php
                        if (check_permission(538, 1013, 0)) {
                        ?>
                            <a data-toggle="modal" class="btn btn-primary btn-xs" data-toggle="tooltip" title="Add a new template" data-placement="left" href="javascript:void(0)" onclick="add_new_template();"><i class="fa fa-plus"></i>CREATE NEW TEMPLATE</a>
                        <?php
                        }
                        ?>
                    </div>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if (check_permission(538, 1013, 0)) {
                                                        ?>
                                                            <a href="javascript:void(0)" onclick="edit_ohtemplate('<?php echo $oh['id']; ?>', '<?php echo $oh['name']; ?>', '<?php echo $oh['description']; ?>');" data-toggle="tooltip" data-placement="right" title="Edit <?php echo $oh['name']; ?>" data-original-title="<?php echo $oh['name']; ?>"><i class="fa fa-pencil" style="font-size: 24px; color: #23C6C5; margin: 2%; "></i></a>
                                                        <?php
                                                        }
                                                        ?>
                                                    </td>
...
<script type="text/javascript">
    ...
    function submit_data() {
        ...
        var ops_url = baseurl + 'substore/add-ohtemplate/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function submit_edit_data() {
        ...
        var ops_url = baseurl + 'substore/edit-ohtemplate/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function edit_ohtemplate(id, name, description) {
        var ops_url = baseurl + 'substore/edit-ohtemplate/';
        $.ajax({
            type: "POST",
            cache: false,
