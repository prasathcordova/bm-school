            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools" id="ibox_tool">
                        <span><a href="javascript:void(0)" onclick="view_student_allotment();"> <i style="font-size: 30px !important;  color: #23C6C5;" class="material-icons">close</i></a> </span>
                    </div>
                </div>
...
<script type="text/javascript">
    function list_student_assigned(openhouse_id, template_id) {
        var ops_url = baseurl + 'substore/list-stud_assigned/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function openhouse() {
        ...
        var ops_url = baseurl + 'substore/openhouse-search/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
