            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools" id="add_type">
                        <span><a href="javascript:void(0);" onclick="submit_data();"> <i style="font-size: 35px !important;  float: right;color: #23C6C5;" class="material-icons">save</i></a> </span>
                    </div>
                </div>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                            ...
                                                                            <tr role="row" class="odd">
                                                                                ...
                                                                                <td><a href="javascript:void(0);"><span id="discard_<?php echo $value['item_id'] ?>" class="label label-warning pull-left" onclick="deletedisplay('<?php echo $value['item_id'] ?>', '<?php echo $price ?>', '<?php echo $value['tax_type'] ?>', '<?php echo $value['tax_value'] ?>');"><i class="fa fa-trash-o" aria-hidden="true"></i></span></a></td>
                                                                            </tr>
                                                                    <?php
                                                                            if ($value['tax_type'] == 'P') {
