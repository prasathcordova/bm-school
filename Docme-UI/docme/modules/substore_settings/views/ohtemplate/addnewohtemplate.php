                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            ?> ">
                                <input type="text" class="form-control text-uppercase" name="country_abbr" maxlength="30" id="country_abbr" value="<?php echo set_value('country_abbr', isset($country_abbr)?$country_abbr:'');  ?>" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            ?> ">
                                <input type="text" class="form-control text-uppercase" name="country_nation" maxlength="30" id="country_nation" value="<?php echo set_value('country_nation', isset($country_nation)?$country_nation:'');  ?>" />
                            </div>
                        </div>
                    </div>
                      <div class="col-lg-6">
                        ...
                        ?>">
                            <label>Currency Name</label><span class="mandatory" > *</span><br/>
