                    ...
                    <div class="file-manager">
                        ...
                        <ul class="category-list" style="padding: 0">
                            <li><a href="javascript:void(0);" onclick="load_district();"> <i class="fa fa-circle text-warning"></i> Purchase List<span class="label label-warning pull-right">16</span> </a></li>
                                    <li><a href="javascript:void(0);" onclick="load_supplier();"> <i class="fa fa-circle text-primary"></i> Direct Purchase  <span class="label label-warning pull-right">16</span> </a></li>
                                    <li><a href="javascript:void(0);" onclick="load_publisher();"> <i class="fa fa-circle text-info"></i> Purchase Order  <span class="label label-warning pull-right">16</span> </a></li>
...
<!--<li><a href="<?php // echo base_url('course/batch-allocate');  ?>"> <i class="fa fa-circle text-warning"></i> District-->                                     
                            ...
                            <!--                            <li><a href="javascript:void(0);" onclick="load_religion();"> <i class="fa fa-circle text-navy"></i> Item Transfer <span class="label label-warning pull-right">16</span> </a></li>-->
                                                    ...
                                                    <h5>Sale Settings</h5>
                                                    <ul class="category-list" style="padding: 0">
                                                        <li><a href="javascript:void(0);" onclick="sale();"> <i class="fa fa-circle text-navy"></i> Sale <span class="label label-warning pull-right">2</span> </a></li>
