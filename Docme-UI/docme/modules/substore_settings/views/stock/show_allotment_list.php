                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if ($stockAllot['isapproved'] == 1) { ?>
                                                                &nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" onclick="view_allotment('<?php echo $stockAllot['masterid']; ?>');" data-toggle="tooltip" data-placement="right" title="View Approved Allotment" data-original-title="<?php // echo $category['cate_name'];    
...
<script type="text/javascript">
    ...
    function view_allotment(allotment_id) {
        var ops_url = baseurl + 'stock/view-allotment-substore/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
