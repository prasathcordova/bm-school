        ...
        <div class="card">
            <div class="header">
                <h2 style="padding-bottom: 10px;font-size: 16px;"><?php echo isset($title) ? $title : "NO TITLE PROVIDED" ?>
                    ...
                    <span><a href="javascript:void(0);" onclick="emp_search_data();"> <i style="font-size: 30px !important; float: right; color: #23C6C5; padding-right: 10px;" class="fa fa-search" data-toggle="tooltip" title="Search"></i></a> </span>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-info" onclick="search_name();"> Search</button>
                                                    ...
                                                    <div class="contact-box center-version">
                                                        ...
                                                        <div class="contact-box-footer" style="padding: 5px 5px;">
                                                            <div class="m-t-xs btn-group">
                                                                <a href="javascript:void(0);" onclick="specimen_delivery('<?php echo $staff['Emp_id']; ?>')" class="btn btn-xs btn-white"><i class="fa fa-user-plus"></i>Specimen Delivery</a>
...
<script type="text/javascript">
    function emp_search_data() {
        var ops_url = baseurl + 'delivery/search-emp-data';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function specimen_delivery(Emp_id) {
        //        var batchid = $('#batchid').val();
        var ops_url = baseurl + 'substore/specimen-delivery/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
