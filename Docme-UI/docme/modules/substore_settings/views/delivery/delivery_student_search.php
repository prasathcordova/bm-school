...
<div class="row">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <i class="fa fa-info-circle"></i>Student Items Delivery

            <a href="javascript:void(0)" onclick="delivery_student();" id="close_button" data-toggle="tooltip" title="Close" style="float: right; color: #B22222;"><i class="fa fa-close"></i></a>
        </div>
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <div class="input-group"><input type="text" id="searchname" name="searchname" placeholder="Enter Admission Number" class="form-control"> <span class="input-group-btn">
                                    <button type="button" id="button_id_1" class="btn btn-primary" onclick="search_name();"><i class="fa fa-search"></i></button> </span>
                            </div>
                        </div>
                    </div>

                </div>
                <div class="col-md-12" id="voucher_search_id">
                    <b>Voucher No</b>
                    <div class=" input-group" style="padding-bottom: 5%;">
                        ...
                        <span class="input-group-btn">
                            <button type="button" id="button_id_2" class="btn btn btn-primary" onclick="search_voucher();"> <i class="fa fa-search"></i></button>
                        ...
                        <div>
                            <select class="select2_registration form-control" id="batch_id" name="batch_id">
                                ...
                                if (isset($batch_data) && !empty($batch_data)) {
                                    echo '<option selected value="-1">Selected</option>';
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-line">
                            <div class="input-group"><input type="text" placeholder="Enter Student Name" id="sname" name="sname" class="form-control">
                                <span class="input-group-btn"> <button id="button_id_3" type="button" class="btn btn-primary" onclick="searchadvance_filtername();"><i class="fa fa-search"></i></button> </span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function search_name() {
        ...
        var ops_url = baseurl + 'sales/search-student-delivery';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function search_voucher() {
        ...
        var ops_url = baseurl + 'sales/search-voucher-delivery';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
            ...
            success: function(result) {
                ...
                if (data.status == 1) {
                    $('#student-data-containerview').html('');
                    $('#advanced_search_h').html('');
                    $('#advanced_search').html('');
                    $('#direct_search').html('');
                    $('#student-data-container').html(data.view);
    ...
    function searchadvance_filtername() {
        ...
        var ops_url = baseurl + 'delivery/advancesearch-studentname';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
