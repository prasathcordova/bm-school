    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <a href="javascript:void(0)" onclick="close_replace();" data-toggle="tooltip" title="Close" style="float: right; color: #B22222;"><i class="fa fa-close"></i></a>
            ...
            <div class="panel-body">
                <div class="title-action" style="text-align: right;padding-top: 0px; padding-bottom: 10px;">
                    ...
                    ?>
                    <!--<a href="javascript:void(0)" onclick="submit_data('<?php // echo $details_data[0]['id'];  
                                                                            ?>' , '<?php // echo $details_data[0]['delivery_number'];  
                                                                                    ?>')"  target="_blank" class="btn btn-primary"> Confirm Delivery </a>-->
                    <?php // } 
                    ?>
                </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><a href="javascript:void(0)" onclick="replaced_item('<?php echo $items['item_id'] ?>')" data-toggle="tooltip" title="Replace Item"><i class="fa fa-exchange"></i></a></td>
                                        </tr>
                                <?php
                                        //                                    }
                                    }
...
<script>
    ...
    function replaced_item(item_id) {
        //        alert(item_id);
        ...
        //        alert(delivery_id);
        var ops_url = baseurl + 'delivery/replace-item';
        swal({
            title: "Are you sure?",
