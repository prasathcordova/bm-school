                    ...
                    <div class="contact-box center-version">
                        ...
                        <div class="contact-box-footer">
                            <div class="m-t-xs btn-group">
                                <a href="javascript:void(0);" title="Deliver items to <?php echo $student['student_name'] ?>" onclick="bill_detail_delivery('<?php echo $student['student_id']; ?>')" class="btn btn-xs btn-white"><i class="fa fa-user-plus"></i> Delivery</a>
                            </div>
                        </div>
