        ...
        <div class="card">
            <div class="header">
                <h2 style="padding-bottom: 10px;font-size: 16px;"><?php echo isset($title) ? $title : "NO TITLE PROVIDED" ?>
                    ...
                    <span><a href="javascript:void(0);" onclick="st_search_data();"> <i style="font-size: 30px !important; float: right; color: #23C6C5; padding-right: 10px;" class="fa fa-search" data-toggle="tooltip" title="Search"></i></a> </span>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="input-group" style="margin-bottom:26px">
                            ...
                            <span class="input-group-btn">
                                <button type="button" class="btn btn-info" onclick="search_name('<?php echo $this->session->userdata('acd_year'); ?>');"> Search</button>
                                                ...
                                                <div class="ibox-content">
                                                    <div class="col-lg-12">
                                                        <div class="panel panel-info">
                                                            <!--<div class="panel-heading"><strong><?php // echo $batch['class_details']['description'] 
                                                                                                    ?> </strong></div>-->
                                                            <div class="ibox-content">
                                                                <div class="row">
...
<script type="text/javascript">
    ...
    function st_search_data() {
        var ops_url = baseurl + 'delivery/search-st-data';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function load_students_after_filter(batchid, acd_yr = 0) {
        ...
        var ops_url = baseurl + 'delivery/students_batch';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
