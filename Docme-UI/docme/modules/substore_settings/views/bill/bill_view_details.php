        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <div class="row" style="padding:20px; display: none;" id="bill_cancel_id">
                    ...
                    <a class="btn btn-info" id="cash_pay_btn" style="margin-left:30px; margin-top:18px; " href="javascript:void(0);" onclick="submit_bill_cancel('<?php echo $billid; ?>');">
...
<script type="text/javascript">
    ...
    function print_bill_demo(billid) {
        var link = baseurl + 'substore/bill-print-other/' + billid;
        window.open(link, '_blank');
    }
    ...
    function submit_bill_cancel(billid) {
