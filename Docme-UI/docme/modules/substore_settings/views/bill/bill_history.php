                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example" id="tbl_bill" >
                                    ...
                                    <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span> <a href="javascript:void(0);" onclick="bill_detail();"  data-toggle="tooltip" data-placement="right" title="view Bill" data-original-title=""  ><i class="fa fa-eye" style="font-size: 24px; color: #23C6C5; margin: 2%; "></i></a>  </span>                                                     
...
//                    activate_toast("Connection Error", 'Error', 'error');
    ...
    function bill_detail1() {
        var ops_url = baseurl + 'bill/viewbill-history/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
