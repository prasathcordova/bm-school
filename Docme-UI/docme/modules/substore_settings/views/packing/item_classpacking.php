                ...
                <div class="ibox-content">
                    <div class="input-group" style="margin-bottom:26px">
                        ...
                        <span class="input-group-btn">
                            <button type="button" id="search_name_btn" class="btn btn-info" onclick="search_name('<?php echo $this->session->userdata('acd_year'); ?>');"> Search</button>
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="panel panel-info" style="padding-top: 1px;">
                                                ...
                                                <div class="panel-footer" style="background-color : white;text-align: center;">
                                                    <a href="javascript:void(0);" onclick="load_students_after_filter('<?php echo $batch['class_details']['class_id']; ?>')" data-toggle="tooltip" title="List of students"><span class="label label-warning-light">Select <i class="fa fa-long-arrow-right"></i></span></a>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    function batch_list(class_id) {
        var ops_url = baseurl + 'substore/class_item_list/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function load_students_after_filter(class_id, acd_yr = 0) {
        ...
        var ops_url = baseurl + 'sale/students_batch';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
