            ...
            <div class="col-lg-12">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        ...
                        <a href="javascript:void(0);" id="save_emppacking" onclick="submit_data();"> <i style="font-size: 27px !important; float: right; color: #ffffff; padding-right: 0px;" class="material-icons" data-toggle="tooltip" title="Save">save</i></a>
                    </div>
                    <div class="panel-body">
