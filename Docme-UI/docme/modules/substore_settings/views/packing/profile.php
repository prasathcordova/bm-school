                    ...
                    <div class="ibox-content">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="button" id="search_name_btn" class="btn btn-info" onclick="search_name('<?php echo $acdyr_id; ?>', '<?php echo $batch_id; ?>');"> Search</button>
                            </span>
                        </div>
                        <div class="row">
                                                    ...
                                                    <div class="contact-box center-version">
                                                        ...
                                                        <div class="contact-box-footer">
                                                            <div class="m-t-xs btn-group">
                                                                <a href="javascript:void(0);" title="Select <?php echo $student['student_name'] ?>" onclick="loose_packing('<?php echo $student['student_id']; ?>')" class="btn btn-xs btn-white"><i class="fa fa-user-plus"></i> Select</a>
                                                            </div>
                                                        </div>
...
<script>
    ...
    function search_name(acdyr_id, batch_id) {
        ...
        var ops_url = baseurl + 'packing/search-profilename';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
