                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                        <!--<a href="javascript:void(0);" onclick="edit_allotment('<?php echo $stockAllot['masterid']; ?>', '<?php $stockAllot['description']; ?>', '<?php echo $stockAllot['storeid']; ?>', '<?php echo $stockAllot['net_quantity']; ?>', '<?php echo $stockAllot['net_price']; ?>');"  data-toggle="tooltip" data-placement="right" title="Edit Allotment <?php // echo $category['cate_name'];       
                                                                                                                                                                                                                                                                                                                                                                                                            ?>" data-original-title="<?php // echo $category['cate_name'];       
                                                                                                                                                                                                                                                                                                                                                                                                                                        ?>"  ><i class="fa fa-pencil" style="font-size: 24px; color: #23C6C8; margin: 2%; "></i></a>-->
                                                        ...
                                                        <?php // } else { 
                                                        ?>
                                                        &nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" onclick="view_allotment('<?php echo $stockAllot['masterid']; ?>');" data-toggle="tooltip" data-placement="right" title="View Allotment Status" data-original-title="<?php // echo $category['cate_name'];       
                                                                                                                                                                                                                                                                            ?>"><i class="fa fa-file" style="font-size: 24px; color: #23C6C8; margin: 2%; "></i></a> <?php // } 
                                                                                                                                                                                                                                                                                                                                                                        ?>
                                                    </td>
                                                </tr>
                                        <?php
...
<script type="text/javascript">
    ...
    function add_new_allotment_substore() {
        var ops_url = baseurl + 'allotment/add-allotment_sub_out/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function edit_allotment(allotment_id) {
        var ops_url = baseurl + 'stock/allot-edit_out/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function view_allotment(allotment_id) {
        var ops_url = baseurl + 'allotment/view-allotment_out/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
