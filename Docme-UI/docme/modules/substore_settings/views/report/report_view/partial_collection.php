        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td align="right" style="border-bottom: 1px solid #ccc;font-family:Tahoma ; "><?php echo $data['bill_amount']; ?></td>
                        <td align="right" style="border-bottom: 1px solid #ccc;font-family:Tahoma ; "><?php echo $data['paid_amount']; ?></td>
            ...
            ?>
            <!-- <tr>
                <td colspan="2" style="padding-top:25px;padding-left: 15px;border: 0;border-bottom:  1px solid #eee;">Cash Total</td>
