                    ...
                    <div class="ibox-content">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="button" id="search_name_btn" class="btn btn-info" onclick="search_name();"> Search</button>
                                                ...
                                                <div class="contact-box center-version">
                                                    ...
                                                    <div class="contact-box-footer" style="padding: 5px 5px;">
                                                        <div class="m-t-xs btn-group">
                                                            <a href="javascript:void(0);" title="Specimen issue <?php echo $staff['Emp_Name'] ?>" onclick="specimen_packing('<?php echo $staff['Emp_id']; ?>')" class="btn btn-xs btn-white"><i class="fa fa-user-plus"></i>Specimen Issue</a>
...
<script>
    ...
    function specimen_packing(Emp_id) {
    ...
    function search_name() {
        ...
        var ops_url = baseurl + 'substore/search-teachername';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
