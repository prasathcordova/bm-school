        ...
        if ($this->input->is_ajax_request() == 1) {
            ...
            if (isset($startdate) && !empty($startdate) && isset($enddate) && !empty($enddate)) {
                ...
                if (isset($report_data['data_status']) && !empty($report_data['data_status']) && $report_data['data_status'] == 1) {
                    ...
                    $data['store_name'] = '';
                    $data['title'] = "BOOKSTORE - SALE RETURN REPORT  ";
                    $data_header['title'] = "BOOKSTORE - SALE RETURN REPORT  ";
        ...
        if ($this->input->is_ajax_request() == 1) {
            ...
            if (isset($startdate) && !empty($startdate) && isset($enddate) && !empty($enddate)) {
                ...
                if (isset($report_data['data_status']) && !empty($report_data['data_status']) && $report_data['data_status'] == 1) {
                    ...
                    $data['enddate'] = $enddate;
                    $data['store_name'] = '';
                    $data['title'] = "BOOKSTORE - SALE  REPORT  ";
                    $data_header['title'] = "BOOKSTORE - SALE  REPORT  ";
                    $data['user_name'] = $this->session->userdata('user_name');
                    $data['report_data'] = $report_data['data'];
        ...
        if ($this->input->is_ajax_request() == 1) {
            ...
            if (isset($startdate) && !empty($startdate) && isset($enddate) && !empty($enddate)) {
                ...
                if (isset($report_data['data_status']) && !empty($report_data['data_status']) && $report_data['data_status'] == 1) {
                    ...
                    $data['enddate'] = $enddate;
                    $data['store_name'] = '';
                    $data['title'] = "BOOKSTORE - SALE  REPORT ITEM WISE ";
                    $data_header['title'] = "BOOKSTORE - SALE  REPORT ITEM WISE ";
                    $data['user_name'] = $this->session->userdata('user_name');
                    $data['report_data'] = $report_data['data'];
        ...
        if ($this->input->is_ajax_request() == 1) {
            ...
            if (isset($startdate) && !empty($startdate) && isset($enddate) && !empty($enddate)) {
                ...
                if (isset($report_data['data_status']) && !empty($report_data['data_status']) && $report_data['data_status'] == 1) {
                    ...
                    $data['enddate'] = $enddate;
                    $data['store_name'] = '';
                    $data['title'] = "BOOKSTORE - SALE  REPORT ITEM WISE SUMMARY REPORT ";
                    $data_header['title'] = "BOOKSTORE - SALE  REPORT ITEM WISE SUMMARY REPORT";
                    $data['user_name'] = $this->session->userdata('user_name');
                    $data['report_data'] = $report_data['data'];
        ...
        if ($this->input->is_ajax_request() == 1) {
            ...
            if (isset($startdate) && !empty($startdate) && isset($enddate) && !empty($enddate)) {
                ...
                if (isset($report_data['data_status']) && !empty($report_data['data_status']) && $report_data['data_status'] == 1) {
                    ...
                    $data['enddate'] = $enddate;
                    $data['store_name'] = '';
                    $data['title'] = "BOOKSTORE - BILLED BUT NOT DELIVERED ITEM WISE SUMMARY REPORT ";
                    $data_header['title'] = "BOOKSTORE - BILLED BUT NOT DELIVERED ITEM WISE SUMMARY REPORT";
                    $data['user_name'] = $this->session->userdata('user_name');
                    $data['report_data'] = $report_data['data'];
                    ...
                    date_default_timezone_set('Asia/Kolkata');
                    $date = date('d-m-Y h:i:s');
                    $footer = '<div style="font-size:10px;font-weight: normal;">' . 'Docme -> Store -> Reports -> Billed but not delivered. <br/> Printed on : ' . $date . '|{PAGENO}|' . '<div style="font-size:10px;font-weight: normal;">Generated By : ' . $data['user_name'] . '</div></div>';
                    $reportlink = $this->generate_pdf_report_sale_all($html, $data['user_name'], $header, $footer);
                    if ($reportlink) {
                        echo json_encode(array('status' => 1, 'link' => base_url("download/" . $reportlink)));
                        return true;
        ...
        if ($this->input->is_ajax_request() == 1) {
            ...
            if (isset($startdate) && !empty($startdate) && isset($enddate) && !empty($enddate)) {
                ...
                if (isset($report_data['data_status']) && !empty($report_data['data_status']) && $report_data['data_status'] == 1) {
                    ...
                    $data['enddate'] = $enddate;
                    $data['store_name'] = '';
                    $data['title'] = "BOOKSTORE - COLLECTION REPORT ";
                    $data_header['title'] = "BOOKSTORE - COLLECTION REPORT";
                    $data['user_name'] = $this->session->userdata('user_name');
                    $data['report_data'] = $report_data['data'];
        ...
        if ($this->input->is_ajax_request() == 1) {
            ...
            if (isset($startdate) && !empty($startdate) && isset($enddate) && !empty($enddate)) {
                ...
                if (isset($report_data['data_status']) && !empty($report_data['data_status']) && $report_data['data_status'] == 1) {
                    ...
                    $data['enddate'] = $enddate;
                    $data['store_name'] = '';
                    $data['title'] = "BOOKSTORE - PARTIAL COLLECTION REPORT ";
                    $data_header['title'] = "BOOKSTORE - PARTIAL COLLECTION REPORT";
                    $data['user_name'] = $this->session->userdata('user_name');
                    $data['report_data'] = $report_data['data'];
        ...
        if ($this->input->is_ajax_request() == 1) {
            ...
            if (isset($startdate) && !empty($startdate) && isset($enddate) && !empty($enddate)) {
                ...
                if (isset($report_data['data_status']) && !empty($report_data['data_status']) && $report_data['data_status'] == 1) {
                    ...
                    $data['enddate'] = $enddate;
                    $data['store_name'] = '';
                    $data['title'] = "BOOKSTORE - COLLECTION REPORT USER WISE ";
                    $data_header['title'] = "BOOKSTORE - COLLECTION REPORT USER WISE";
                    $data['user_name'] = $this->session->userdata('user_name');
                    $data['report_data'] = $report_data['data'];
        ...
        if ($this->input->is_ajax_request() == 1) {
            ...
            if (isset($startdate) && !empty($startdate) && isset($enddate) && !empty($enddate)) {
                ...
                if (isset($report_data['data_status']) && !empty($report_data['data_status']) && $report_data['data_status'] == 1) {
                    ...
                    $data['enddate'] = $enddate;
                    $data['store_name'] = '';
                    $data['title'] = "BOOKSTORE - SUMMARY COLLECTION REPORT USER WISE ";
                    $data_header['title'] = "BOOKSTORE - SUMMARY COLLECTION REPORT USER WISE";
                    $data['user_name'] = $this->session->userdata('user_name');
                    $data['report_data'] = $report_data['data'];
