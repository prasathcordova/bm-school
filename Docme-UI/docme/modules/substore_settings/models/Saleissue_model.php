...
class Saleissue_model extends CI_Model
{
    ...
    {
        $apikey = $this->session->userdata('API-Key');
        $user_data = transport_data_with_param_with_urlencode(array('action' => 'search_item_stock_for_substore', 'store_id' => $store_id, 'name' => $search_item, 'code' => $search_item, 'barcode' => $search_item), $apikey);
