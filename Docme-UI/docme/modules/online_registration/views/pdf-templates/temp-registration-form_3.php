...
<body>
    ...
    <table class="table" width="100%" cellpadding="5">
        <tr>
            <td align="left">
                <span style="font-weight:bold;font-size:14px">Dear Applicant,<br /><br />
                    Thank you for using our online registration facility. <b><?php echo $temp_data['TempAdmn_No']; ?></b> is your temporary Token No. valid for 2 working days only.
                </span><br /><br />
    ...
    <table class="table" width="100%" cellpadding="5">
        <tr>
            <td style="font-size:14px" width="39%" align="left">Standard to which Registration is required</td>
            <td align="right" width="2%">:</td>
            <td align="left">
        ...
        <tr>
            <td style="font-size:14px" align="left">Syllabus to which Registration is required</td>
            <td align="right" width="2%">:</td>
            <td align="left">
    ...
    <div class="rounded-border details_table_div">
        <table class="table-bordered" width="100%" cellspacing="0">
            <tr>
                ...
                <td class="" align="left" style="font-size:13px" width="25%"> <?php echo $age_string; ?></td>
            </tr>
            <tr>
                <td class="first_cl italic_font" width="25%" align="left">
                    Country of Birth
                ...
                <td class="dotted-border default-font" align="left" width="25%"><?php echo $temp_data['birthPlace']; ?> </td>
            </tr>
            <tr>
                <td class="first_cl italic_font" width="25%" align="left">
                    Nationality
    ...
    <div class="rounded-border details_table_div" style="height:140px;padding:25px;border-bottom:1px solid">
        <h4 style="text-decoration:underline;text-align:left">Conditions:</h4><br />
        ...
        <br />
        <h4 style="text-decoration:underline;text-align:left">Documents to be submitted:</h4><br />
        <div style="margin-left:50px">
            a) Attested Birth Certificate, Passport copy with valid Visa (both the Student's and the Parent's), Attested TC,
            Emirates ID of the Student (Original), 2 Photographs, Vaccination Card, Annual Exam Mark list.<br />
            b) Copy of this Acknowledgement.

        </div>
        <br />
        <span class="italic_font" style="font-weight:bold"><span style="text-decoration:underline">Note:</span>Submission of the above documents <span style="text-decoration:underline">within 2 working days</span> will save you from invalidation of your
            request. Registration fee is non - refundable.</span>
    ...
    <table cl ass="table" width="100%" style="margin:auto">
        ...
        <tr>
            ...
            <td align="right" width="2%">:</td>
            <td colspan=2 align="left" class="dotted-border"></td>
        </tr>
    </table>
