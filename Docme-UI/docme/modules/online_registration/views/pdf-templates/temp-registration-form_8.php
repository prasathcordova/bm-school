        ...
        <tr>
            ...
            <td align="left">
                <?php if ($temp_data['stream_code'] == 'CBSE') {
                    ...
                    $icse_img = 'unchecked-checkbox.png';
                    $kb_img = 'unchecked-checkbox.png';
                } else if ($temp_data['stream_code'] == 'ICSE') {
                    $cbse_img = 'unchecked-checkbox.png';
                    $monti_img = 'unchecked-checkbox.png';
                    $icse_img = 'checked-checkbox.png';
                    $kb_img = 'unchecked-checkbox.png';
                } else {
                    $cbse_img = 'checked-checkbox.png';
                ...
                <span class="img-label">ICSE</span> <img class="img-check" src="<?php echo base_url('assets/img/online-reg/' . $icse_img); ?>" alt="Logo" />
