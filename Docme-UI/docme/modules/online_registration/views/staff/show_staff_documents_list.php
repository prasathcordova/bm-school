                            ...
                            <div class="col-lg-12" id="close-main-content">
                                <div class="col-lg-6 col-xs-12 col-md-12">
                                    <div class="form-group ">
                                        ...
                                        <select class="select2_registration form-control" id="academic_year" name="academic_year" disabled style="width: 100%">
                                            <?php
...
<script type="text/javascript">
    ...
    function get_data() {
        ...
        var ops_url = baseurl + 'online-registration/get-staff-status';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
    ...
    function submit_data() {
       $("#faculty_loader").addClass("sk-loading");
        ...
        $.ajax({
            ...
            async: false,
            url: ops_url,
            data: {verify_table: verify_table},
            success: function(result) {
                console.log(result);
