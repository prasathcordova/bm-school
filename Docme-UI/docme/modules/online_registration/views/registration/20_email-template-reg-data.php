                        ...
                        <tr>
                            <td class="content-wrap">
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <img class="img-responsive" src="<?php echo base_url('assets/OnlineRegLogos/' . $temp_data['inst_id'] . '_logo.png'); ?>" alt="logo" style="width:250px" />
                                    ...
                                    <?php if ($temp_data['registration_fees'] != 0 && $payment_link != '') { ?>
                                        <tr>
                                            <td class="content-block">
                                                <br /><b> For Online Payment ,Please visit below link if not paid </b><br />
                                                <b>Link :<b /> <?php echo $payment_link; ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="content-block">
                                            a)Copies of Birth Certificate, 2 Photographs, Aadhar of the Parent & the Student.<br />
                                            b)Copy of Acknowledgement attached.<br />
                                            <!-- For uploading documents visit the <a href="<?php echo $upload_link_url; ?>">Link</a> -->
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="content-block">
