                        ...
                        <tr>
                            <td class="content-wrap">
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <img class="img-responsive" src="<?php echo base_url('assets/OnlineRegLogos/' . $temp_data['inst_id'] . '_logo.png'); ?>" alt="logo" />
                                    ...
                                    <tr>
                                        <td class="content-block">
                                            Thank you for using our online registration facility. Your Token Number is <b><?php echo $temp_data['TempAdmn_No']; ?></b> .
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="content-block">
                                    ...
                                    <tr>
                                        <td class="content-block">
                                            ...
                                            2)Final admission depends up on the availability of seats in each grade.
                                        </td>
                                    </tr>

                                    <tr>
                                        <td class="content-block">
                                            <br /><b><u> Note :</u> Submission of the Registration form(attached here) within the prescribed time will save you from invalidation of your request.</b><br />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="content-block">
