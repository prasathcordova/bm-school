                    ...
                    <tr>
                        <td class="content-wrap">
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        Online Payment for your ward <b><?php echo $fname . ' ' . $mname . ' ' . $lname; ?></b> can be done from the following link.
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        Link : <?php echo base_url() ?>registration/online-payment?<?php echo base64_encode('temp_reg_id') ?>=<?php echo base64_encode($TempReg_ID) ?>&<?php echo base64_encode('school_id') ?>=<?php echo base64_encode($inst_id) ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        Payment Amount : Rs.<?php echo $registration_fees ?> /- only
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
