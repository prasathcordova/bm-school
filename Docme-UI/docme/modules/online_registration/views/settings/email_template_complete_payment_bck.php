                        ...
                        <td class="content-wrap">
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <?php if ($type == 1) { ?>
                                    <tr>
                                        <td class="content-block">
                                            Online Payment for your ward <b><?php echo $detail['fname'] . ' ' . $detail['mname'] . ' ' . $detail['lname']; ?></b> is Successful.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="content-block">
                                            Paid Amount : Rs.<?php echo $detail['registration_fees'] ?> /- only
                                        </td>
                                    </tr>
                                ...
                                <?php } else { ?>
                                    ...
                                    <tr>
                                        <td class="content-block">
                                            Online Payment for your ward <b><?php echo $detail['fname'] . ' ' . $detail['mname'] . ' ' . $detail['lname']; ?></b> is Failed.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="content-block">
                                            Try again with the link below, if amount is not debited from account
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="content-block">
                                    ...
                                    <tr>
                                        <td class="content-block">
                                            Payment Amount : Rs.<?php echo  $detail['registration_fees'] ?> /- only
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td class="content-block">
                                            Please contact school if amount already debited.
                                        </td>
                                    </tr>
