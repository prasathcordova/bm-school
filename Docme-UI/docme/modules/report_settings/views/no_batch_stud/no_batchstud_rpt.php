            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content" id="Rptclass_loader">
                    ...
                    <div class="body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a href="javascript:void(0);" class="btn btn-primary btn-sm" onclick="submit_data('<?php echo $acdyr['Acd_ID']  ?>','<?php echo $class['Description']  ?>');"> Report</a>
...
<script type='text/javascript'>
    ...
    function submit_data(Acd_ID) {
        ...
        var ops_url = baseurl + 'report/stud-nobatchstudpdf';
        $.ajax({
            type: "POST",
            cache: false,
            // async: false,
            url: ops_url,
            //            data: {"load": 1,"acd_year": Acd_ID},            
            data: {
                "load": 1,
                "acd_year": Acd_ID,
