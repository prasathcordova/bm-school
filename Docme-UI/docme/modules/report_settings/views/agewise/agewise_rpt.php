    ...
    <div class="row" style="margin-left: -29px !important; margin-right: -30px !important;">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content" id="Rptagewise_loader">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group <?php
                                                        ...
                                                        ?>">
                                    <label>Age</label><span class="mandatory"> *</span><br />
                                    ...
                                    <?php echo form_error('age', '<div class="form-error">', '</div>'); ?>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<script type='text/javascript'>
    ...
    function submit_data() {
        $('#Rptagewise_loader').addClass('sk-loading');
        ...
        if (Acd_ID == -1) {
            ...
            $('#Rptagewise_loader').removeClass('sk-loading');
            return;
        }
        if (stream_ID == -1) {
        ...
        if (age == '' || age == '-1') {
            swal('', 'Age  is required.', 'info');
            $('#Rptagewise_loader').removeClass('sk-loading');
            return;
        }

        var ops_url = baseurl + 'report/stud-agewisepdf';
        $.ajax({
            type: "POST",
            cache: false,
            // async: false,
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                if (data.status == 1) {
                    ...
                    $('#batch_select').empty().trigger("change");
                    $('#batch_select').append('<option selected value="-1">Select</option>');
                    if (class_id == 1000) {
