...
<script type="text/javascript">
    ...
    function search_name() {
        ...
        var ops_url = baseurl + 'familyreport/search-admission-no';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
            ...
            success: function(result) {
                ...
                if (data.status == 1) {
                    $('#student-profile-content').html('');
                    $('#student-profile-content').html(data.view);
    ...
    function load_students_after_filter(courseid) {
        ...
        //write if condition by vinoth @28-05-2019 10:40
        if (batch_id === '-1') {
            swal('', 'Select Batch', 'info');
            return false;
        }
        var ops_url = baseurl + 'familyreport/show-profile';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
