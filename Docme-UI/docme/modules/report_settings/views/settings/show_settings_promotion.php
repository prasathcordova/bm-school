                ...
                <div class="ibox-content mailbox-content">
                    <div class="file-manager">
                        ...
                        <ul class="category-list" style="padding: 0">
                            ...
                            <?php if (check_permission(508, 1123, 102)) { ?>
                                <li><a href="javascript:void(0);" onclick="load_promotion_details();"> <i class="fa fa-circle text-primary"></i> Promotion Details</a></li>
                            <?php }
                            if (check_permission(508, 1124, 102)) { ?>
                                <li><a href="javascript:void(0);" onclick="load_detained_details();"> <i class="fa fa-circle text-primary"></i> Detained Details</a></li>
                            <?php } ?>
