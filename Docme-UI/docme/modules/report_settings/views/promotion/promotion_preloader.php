        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content" id="Rptnation_loader">
                    ...
                    <div class="body">
                        <?php
                        echo form_open('report/get-promotion-report');
                        ?>
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-6" id="form_data">
                                <!-- <div class="form-group" id="data_1">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" data-date-startdate="2017-12-05" class="form-control" autocomplete="off" name="reportdate" id="reportdate" value="<?php echo date('d-m-Y') . " - " . date('d-m-Y'); ?>" />
                                    </div>
                                </div> -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a href="javascript:void(0);" class="btn btn-primary btn-sm" onclick="submit_data_for_promotion_report(1);"> Report</a>
                                <a href="javascript:void(0);" class="btn btn-primary btn-sm" onclick="submit_data_for_promotion_report(2);"> Export to Excel</a>
                            </div>
                        </div>
...
<script type='text/javascript'>
    ...
    function submit_data_for_promotion_report(rpt_type) {
        ...
        //     return;
        // }
        var ops_url = baseurl + 'report/get-promotion-report';
        $.ajax({
            type: "POST",
            cache: false,
            // async: false,
    ...
    // function submit_data_for_promotion_report() {
    //     if ($('#reportdate').val() === '') {
