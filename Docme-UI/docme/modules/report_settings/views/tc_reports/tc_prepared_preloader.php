            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content" id="Rptclass_loader">
                    ...
                    <div class="body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a href="javascript:void(0);" class="btn btn-primary btn-sm" onclick="submit_data_for_tc_prepared(1);"> Report</a>
                                <a href="javascript:void(0);" class="btn btn-primary btn-sm" onclick="submit_data_for_tc_prepared(2);"> Export to Excel</a>
                            </div>
                        </div>
...
<script type='text/javascript'>
    ...
    function submit_data_for_tc_prepared(rpt_type) {
        ...
        //     return;
        // }
        var ops_url = baseurl + 'report/get-tc-prepared-report';
        $.ajax({
            type: "POST",
            cache: false,
            // async: false,
