        ...
        <div class="card">
            <div class="header">
                <h2 style="padding-bottom: 10px;font-size: 16px;"><?php echo isset($title) ? $title : "NO TITLE PROVIDED" ?>
                    <span><a href="javascript:void(0);"  onclick="close_add_publisher();" > <i style="font-size: 30px !important; float: right; color: #E91E63;" class="material-icons" data-toggle="tooltip" title="Close">close</i></a> </span>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            ?> "> 
                                <input type="text" class="form-control text-uppercase" maxlength="150"  name="address1" id="address1" value="<?php echo set_value('address1', isset($address1) ? $address1 : ''); ?>" />
                            </div>                           
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            ?> "> 
                                <input type="text" class="form-control text-uppercase" maxlength="150" name="address2" id="address2" value="<?php echo set_value('address2', isset($address2) ? $address2 : ''); ?>" />
                            </div>                           
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            ?> "> 
                                <input type="text" class="form-control text-uppercase" maxlength="150" name="address3" id="address3" value="<?php echo set_value('address3', isset($address3) ? $address3 : ''); ?>" />
                            </div>                           
                        </div>
                    </div>
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            ?> "> 
                                <input type="text" class="form-control text-uppercase" maxlength="15" name="contact" id="contact" value="<?php echo set_value('contact', isset($contact) ? $contact : ''); ?>" />
                            </div>                           
                        </div>
                    </div>
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            ?> "> 
                                <input type="text" class="form-control text-uppercase" maxlength="150" name="email" id="email" placeholder="" value="<?php echo set_value('email', isset($email) ? $email : ''); ?>" />
                            </div>                           
                        </div>
                    </div>
                    <?php echo form_close(); ?>
