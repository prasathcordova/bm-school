...
<div class="wrapper wrapper-content animated fadeInRight" style="padding-top: 1px !important;padding-left: 0px !important;padding-right: 0px !important;">
                    ...
                    <div class="panel-body panel-body-new">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                Stock Allotment Report Parameter
                            </div>
                            <div class="ibox-content">
                                <div class="row">     
                                    <div class="col-lg-6">
                                        <div class="form-group"><label class="control-label">From Stores</label>                                            
                                            <select class="form-control" name="fromstore" id="fromstore" >
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group"><label class="control-label">To Stores</label>                                            
                                            <select class="form-control" name="tostore" id="tostore" >
                                                <option value="-1">Select a store</option>
                                                <?php
                                                if (isset($store_data) && !empty($store_data)) {
                                                    foreach ($store_data as $store) {
    ...
    <script type="text/javascript">
        ...
        function submit_data() {
            ...
            var from_store_id = $('#fromstore :checked').val();
            var to_store_id = $('#tostore :checked').val();
            ...
            if (moment(startdate).isValid() && moment(enddate).isValid() && store_id > 0) {
                ...
                $.ajax({
                    ...
                    async: false,
                    url: ops_url,
                    data: {"startdate": reportstartdate, "enddate": reportenddate, "from_store_id": from_store_id,"to_store_id":to_store_id, "storename": storename},
