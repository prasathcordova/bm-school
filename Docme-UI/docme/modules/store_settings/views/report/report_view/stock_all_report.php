        ...
        <table  class="table2 tableH" cellpadding="1" width="100%" style="font-family:Tahoma;" style="font-size: 15px; margin-top: 10px;" >
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid #ccc; ">
                            ...
                            <td width="2px" align="left"  style="border-bottom: 1px solid #ccc;font-family:Tahoma ; "><?php echo $data['item_data']['item_name']; ?></td>
                            <td align="center"  style="border-bottom: 1px solid #ccc;font-family:Tahoma ; "><?php echo $data['item_data']['edition_name']; ?></td>
                            <td  align="right"  style="border-bottom: 1px solid #ccc;font-family:Tahoma ; "><?php echo $data['stock_data']['opening_balance']; ?></td>
                            <td align="right" style="border-bottom: 1px solid #ccc;font-family:Tahoma ; "><?php echo $data['stock_data']['purchase']; ?></td>
                            <td  align="right"  style="border-bottom: 1px solid #ccc;font-family:Tahoma ; "><?php echo $data['stock_data']['sale_return']; ?></td>
                            <td  align="right" style="border-bottom: 1px solid #ccc;font-family:Tahoma ; "><?php echo $data['stock_data']['transfer_in']; ?></td>
                            <td  align="right" style="border-bottom: 1px solid #ccc;font-family:Tahoma ; "><?php echo $data['stock_data']['spec_return']; ?></td>
                            <td  align="right" style="border-bottom: 1px solid #ccc; font-family:Tahoma ;"><?php echo $data['stock_data']['purchase_return']; ?></td>
                            <td  align="right" style="border-bottom: 1px solid #ccc; font-family:Tahoma ;"><?php echo $data['stock_data']['sale']; ?></td>
                            <td  align="right" style="border-bottom: 1px solid #ccc;font-family:Tahoma ; "><?php echo $data['stock_data']['transfer_out']; ?></td>
                            <td  align="right" style="border-bottom: 1px solid #ccc;font-family:Tahoma ; "><?php echo $data['stock_data']['spec_issue']; ?></td>
                            <td  align="right" style="border-bottom: 1px solid #ccc;font-family:Tahoma ; "><?php echo $data['stock_data']['closing_stock']; ?></td>
                        </tr>
                        <?php
                        $i++;
                    }
