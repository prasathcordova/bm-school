            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools" id="add_type">
                        <a data-toggle="modal" class="btn btn-primary btn-xs" data-toggle="tooltip" title="Add new Stock Category" data-placement="left"href="javascript:void(0);" onclick="add_new_category();"><i class="fa fa-plus"></i>ADD STOCK CATEGORY</a>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $('#tbl_category').dataTable({
        ...
        columnDefs: [
            ...
            {"width": "25%", className: "capitalize", "targets": 3, "orderable": false}
        ],
        responsive: true,
        iDisplayLength: 10,
...
//        }
        ...
        if (cate_description == '') {
            ...
            $('#data_loader').removeClass('sk-loading');
            return false;
        } else if ((cate_description.length > '50') || (cate_description.length < '3')) {
            swal('', 'Category Description should contain letters 3 to 50', 'info');
            $('#data_loader').removeClass('sk-loading');
            return false;
        }
