                                    ...
                                    <div class="row">
                                                ...
                                                <div class="row" >
                                                    ...
                                                    <div class="col-md-4" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" style="background-color: #FFFFFF" class="form-control text-uppercase" disabled name="total_qty" id="total_qty" value="30" />
                                                    ...
                                                    <div class="col-md-4" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" style="background-color: #FFFFFF" class="form-control text-uppercase" disabled name="sub_total" id="sub_total" value="1350" />
                                                    ...
                                                    <div class="col-md-4" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" style="background-color: #FFFFFF" class="form-control text-uppercase" disabled name="net_value" id="net_value" value="1350" />
                                                    ...
                                                    <div class="col-md-4" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" style="background-color: #FFFFFF" class="form-control text-uppercase" disabled name="remark" id="remark" value="emergency order" />
                                        ...
                                        <div class="col-md-4" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" style="background-color: #FFFFFF" class="form-control text-uppercase" disabled name="approval_c" id="approval_c" value="Test Approved" />
