                                                ...
                                                <div class="row" >                                                    
                                                    ...
                                                    <div class="col-md-4" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" style="background-color: #FFFFFF" class="form-control text-uppercase" disabled="" name="approval_c" id="approval_c" value="<?php echo isset($purchase_data['master_data']['status_desc']) ? ($purchase_data['master_data']['status_desc']) : 'No Status Available'; ?>" />
    ...
    <script type="text/javascript">
        ...
        function save_review_purchase() {
            ...
            if($('#approval_c').val().length < 5) {
                swal('','Comment is mandatory. Please fill in comments');
                return false;
            }
                            ...
                            try {
                                ...
                                if (data.status == 1) {
                                    if(status == 'Approve') {
                                        ...
                                        swal('Success!!', 'Order revied successfully', 'success');
                                    }
