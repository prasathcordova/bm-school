            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><?php echo isset($sub_title) ? $sub_title : "NO TITLE PROVIDED" ?> 
                        <input type="hidden" name="supplier_id" id="supplier_id" value="<?php echo $suppier_id ?>" />
                        <input type="hidden" name="purchase_id" id="purchase_id" value="<?php echo $purchase_id ?>" />
                    </h5>
                    <div class="ibox-tools" id="add_type">
                        <span><a href="javascript:void(0);"  data-toggle="tooltip" data-placement="right" title="Save order details"  onclick="save_edit_purchase();" > <i style="font-size: 35px !important;  float: right;color: #23C6C5;" class="material-icons">save</i></a> </span>
                    </div>
                </div>
                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-md-4" >
                                            ...
                                            <div class="form-group">
                                                <input type="text" style="background-color: #FFFFFF" class="form-control text-uppercase" disabled name="description" id="total_qty" value="<?php echo $purchase_data['master_data']['total_qty']; ?>" />
                                        ...
                                        <div class="col-md-4" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" style="background-color: #FFFFFF" class="form-control text-uppercase" disabled name="description" id="sub_total" value="<?php echo $purchase_data['master_data']['total_value']; ?>" />
                                        ...
                                        <div class="col-md-4" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" style="background-color: #FFFFFF" class="form-control text-uppercase" disabled name="description" id="discount" value="<?php echo $purchase_data['master_data']['discount_value']; ?>" />
                                        ...
                                        <div class="col-md-4" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" style="background-color: #FFFFFF" class="form-control text-uppercase" disabled name="description" id="tax" value="<?php echo $purchase_data['master_data']['tax_value']; ?>" />
                                        ...
                                        <div class="col-md-4" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" style="background-color: #FFFFFF" class="form-control text-uppercase" disabled name="description" id="net_value" value="<?php echo $purchase_data['master_data']['final_order_value']; ?>" />
                                        ...
                                        <div class="col-md-4" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" style="background-color: #FFFFFF" class="form-control text-uppercase" placeholder="Remarks for editing purchase" name="remarks" id="remarks" value="" />
...
//            console.log(jsonitem);
    ...
    function save_edit_purchase() {
        ...
        var ops_url = baseurl + 'purchase/purchase-edit-save/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
            url: ops_url,
            data: {"load": 1, "purchase_id": purchase_id, "final_item_string": final_item_string, "data_counter": data_counter, "total_qty": total_qty, "sub_total": sub_total, "final_order_value": final_order_value, "remarks": btoa(remarks)},
            success: function (result) {
                try {
                    var data = JSON.parse(result);
                    if (data.status == 1) {
                        swal('Success!!', 'Purchase Order edited successfully', 'success');
                        load_purchase();
                        ...
                        if (data.message) {
                            ...
                            swal('', 'An error occurred while editing purchase order. Please try again later or contact administrator with error code : DPRDTAER10003', 'info');
                            return false;
                        }
                    } else {
                        if (data.message) {
