                                                    ...
                                                    <div class="contact-box center-version" style="min-height: 210px; min-width: 150px;">
                                                        ...
                                                        <div class="contact-box-footer">
                                                            <div class="m-t-xs btn-group">
                                                                <a href="javascript:void(0)" onclick="select('<?php echo $suppliers['id']; ?>', '<?php echo $suppliers['name']; ?>')" class="btn btn-xs btn-white"  data-toggle="tooltip" title="Select Supplier"><i class="fa fa-user-plus"></i> Select</a>        
                                                            </div>
                                                        </div>
...
<script>
    ...
    function select(id, name) {
        ...
        var ops_url = baseurl + 'purchase/new-purchaseorder/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
