...
<div class="wrapper wrapper-content animated fadeInRight" style="padding-top: 1px !important;padding-left: 0px !important;padding-right: 0px !important;">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools" id="add_type">
                        <span><a href="javascript:void(0)"  onclick="save_review_purchase();" > <i style="font-size: 35px !important;  float: right;color: #23C6C5;" class="material-icons" data-toggle="tooltip" title="Save">save</i></a> </span>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function save_review_purchase() {
            ...
            swal({
                title: "Are you sure?",
                text: "Do you want to " + status + " the order with order id : " + po_number + " ?",
                type: "warning",
