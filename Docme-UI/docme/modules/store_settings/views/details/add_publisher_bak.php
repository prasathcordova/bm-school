        ...
        <div class="card">
            <div class="header">
                <h2 style="padding-bottom: 10px;font-size: 16px;"><?php echo isset($title) ? $title : "NO TITLE PROVIDED" ?>
                    ...
                    <span><a href="javascript:void(0);"  onclick="submit_data();" > <i style="font-size: 30px !important; float: right; color: #4CAF50; padding-right: 10px;" class="material-icons" data-toggle="tooltip" title="Save">save</i></a> </span>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            ?> ">
                                <input type="text" class="form-control text-uppercase" name="country_abbr" id="country_abbr" value="<?php echo set_value('country_abbr', isset($country_abbr)?$country_abbr:'');  ?>" />
                            </div>
                        </div>
                    </div>
                      <div class="col-lg-6">
