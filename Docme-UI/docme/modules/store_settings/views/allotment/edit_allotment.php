...
<!--                        <div class="col-md-4">
                            <label>Select Sub-store</label>
                            <select class="select2_demo_6 form-control">
                                <option selected value="-1">Select</option>
                                <?php
                                if (isset($substore_data) && !empty($substore_data)) {
                                    foreach ($substore_data as $substore) {
                                        echo '<option value ="' . $substore['store_id'] . '">' . $substore['store_name'] . '</option>';
                                    }
                                }
                                ?>
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="ibox">
                                <div class="ibox-title"> 
                                    <h5 style="font-size: 15px">List of items</h5>
                                    
                                    <!--<title>List of Items</title>-->
                                </div>
                                <div class="ibox-content">       
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover dataTables-example" id="tbl_select" >
                                                ...
                                                if (isset($item_data) && !empty($item_data) && is_array($item_data)) {
                                                    foreach ($item_data as $item) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="javascript:void(0);" onclick="select_item('<?php echo $item['item_id']; ?>', '<?php echo $item['item_name']; ?>', '<?php echo $item['item_code']; ?>', '<?php echo $item['selling_price']; ?>', '<?php echo $item['barcode']; ?>');"  data-toggle="tooltip" data-placement="right" title="Move <?php echo $item['item_name']; ?> to selected items" data-original-title="<?php echo $item['item_name']; ?>" id="select" ><i class="fa fa-paper-plane" style="font-size: 24px; color: #23C6C8; margin: 2%; "></i></a>                                                       
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    }
