                                ...
                                <div class="profile-info">
                                    ...
                                    <div class="">
                                        <div>
                                            ...
                                            <small>
                                                <b>Semester</b> : <?php echo $student_data['Description']; ?>
                                            </small><br>
                                            <small>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <small>Total Demanded Amount : <?php echo my_money_format($total_demand_amt); ?>, Concession/Exemption/Scholarship: <?php echo my_money_format($tot_exp_conc_amount + $tot_scholarship_amount); ?>, Penalty Pending: <?php echo my_money_format($total_penalty); ?>,
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="info-box bg-purple hover-expand-effect hover-zoom-effect">
                                        ...
                                        <div class="content">
                                            <div class="text">PENDING SCHOLARSHIP</div>
                                            <div class="number"><?php echo my_money_format($scholarship_pending_amount); ?></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="info-box bg-cyan hover-expand-effect hover-zoom-effect">
                                        ...
                                        <div class="content">
                                            <div class="text">SCHOLARSHIP AMOUNT</div>
                                            <div class="number"><?php echo my_money_format($scholarship_amount); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        ?>
                                                                                <tr <?php if ($demand['IS_ARREAR'] == 'YES') { ?>style="color:hotpink;" <?php } ?>>
                                                                                    ...
                                                                                    <td class="text-right"><?php echo my_money_format($demand['SCHOLARSHIP_AMOUNT'] + $demand['SCHOLARSHIP_PENDING_AMOUNT']) ?></td>
