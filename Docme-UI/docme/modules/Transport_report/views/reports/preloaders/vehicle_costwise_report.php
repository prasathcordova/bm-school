...
<div class="wrapper wrapper-content animated fadeInRight" style="padding-top: 1px !important;padding-left: 0px !important;padding-right: 0px !important;">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6" id="form_data">
                                        <div class="form-group">
                                            <label class="control-label" style="color:#1c84c6;">First Vehicle</label>
                                            <select name="first_vehicle_select" id="first_vehicle_select" class="form-control " style="width:100%;">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-xs-6" id="form_data">
                                        <div class="form-group">
                                            <label class="control-label" style="color:#1c84c6;">Second Vehicle</label>
                                            <select name="second_vehicle_select" id="second_vehicle_select" class="form-control " style="width:100%;">
    ...
    <script type="text/javascript">
        ...
        $('#first_vehicle_select').select2({
            'theme': 'bootstrap'
        });
        $('#second_vehicle_select').select2({
            'theme': 'bootstrap'
        });
        $('#store').select2({
            'theme': 'bootstrap'
        ...
        function submit_data() {
            ...
            var first_vehicle_id = $('#first_vehicle_select').val();
            var second_vehicle_id = $('#second_vehicle_select').val();

            if (first_vehicle_id == -1) {
                swal('', 'First Vehicle is required.', 'info');
                return false;
            }
            if (second_vehicle_id == -1) {
                swal('', 'Second Vehicle is required.', 'info');
                return false;
            }
            if (first_vehicle_id == second_vehicle_id) {
                swal('', 'Select diffrent vehicle.', 'info');
                return false;
            }

            if (!(moment(startdate).isValid() && moment(enddate).isValid())) {
                swal('', 'Please select a valid date range', 'info');
                return false;
            }
            ...
            if (moment(startdate).isValid() && moment(enddate).isValid()) {
                ...
                var ops_url = baseurl + 'transport-report/vehicle-costwise-report';
                $.ajax({
                    type: "POST",
                    cache: false,
                    async: false,
                    ...
                    data: {
                        ...
                        "seconde_vehicle_id": second_vehicle_id
                    },
