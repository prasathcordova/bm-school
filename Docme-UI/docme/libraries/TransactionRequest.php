...
class TransactionRequest
{
     ...
     * @return the $productId
     */
    public function getCustomerTempRegId()
    {
        return $this->temp_reg_id;
    }

    /**
     * @param string $productId
     */
    public function setCustomerTempRegId($temp_reg_id)
    {
        $this->temp_reg_id = $temp_reg_id;
    }
     ...
     * @return the $productId
     */
    public function getCustomerTempAdmNumber()
    {
        return $this->temp_admission_no;
    }

    /**
     * @param string $productId
     */
    public function setCustomerTempAdmNumber($temp_admission_no)
    {
        $this->temp_admission_no = $temp_admission_no;
    }
     ...
     * @param string $productId
     */
    public function setRegFeeData($reg_amount)
    {
    ...
    private function getData()
    {
        ...
        //$strReqst .= "&udf5=" . $this->getRegFeeData();
        $strReqst .= "&udf6=" . $this->getCustomerTempAdmNumber();
        $strReqst .= "&udf9=" . $this->getCustomerTempRegId();
    ...
    {
        $fileName = "ATOMLOG-date" . date("Y-m-d") . ".txt";
        //$fp = fopen("log/" . $fileName, 'a+');
        $fp = fopen(APPPATH . DIRECTORY_SEPARATOR . "logs" . DIRECTORY_SEPARATOR . $fileName, 'a+');
