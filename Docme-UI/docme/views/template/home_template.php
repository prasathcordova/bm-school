...
<head>
    ...
    <link href="<?php echo base_url('assets/theme/css/plugins/blueimp/css/blueimp-gallery.min.css'); ?>" rel="stylesheet">
    ...
    <script src="<?php echo base_url('assets/theme/js/plugins/blueimp/jquery.blueimp-gallery.min.js'); ?>"></script>
...
<script src="<?php echo base_url('assets/js/settings_loader.js'); ?>"></script>
<script type="text/javascript">
