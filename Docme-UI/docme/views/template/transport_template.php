...
<head>
    ...
    <title><?php echo APP_TITLE; ?>-Transport</title>
    ...
    <link href="<?php echo base_url('assets/css/material-web.css'); ?>" rel="stylesheet">
    ...
    <link href="<?php echo base_url('assets/theme/css/bootstrap-select.css'); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url('assets/theme/css/select_style.css'); ?>" rel="stylesheet" type="text/css" />
    <script src="<?php echo base_url('assets/theme/js/bootstrap-select.js'); ?>" type="text/javascript"></script>
    ...
    <script src="<?php echo base_url('assets/js/material-web.js'); ?>"></script>
    ...
    <!-- Jquery Validate -->
    <script src="<?php echo base_url('assets/theme/js/plugins/validate/jquery.validate.min.js'); ?>"></script>
    ...
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDG1w4XBU-BI0t7hiGFcUfeGaiM8W-CJMs&libraries=places"></script>
