...
<head>
    ...
    <title><?php echo APP_TITLE; ?>-Store</title>
...
<script type="text/javascript">
    ...
    function view_faculty(faculty_id) {
        var ops_url = baseurl + 'faculty/view/';
        if (faculty_id == '45421451421254') {
            swal('Error!!', 'Please Re-login', 'error');
            return false;
        }
        $.ajax({
            type: "POST",
            ...
            success: function(result) {
                ...
                if (data.status == '2') {
                    if ((data.message).length > 0) {
                        ...
                        swal('Error!!', 'Error in loading profile. Please try again later', 'error');
                        return false;
                    }
                    return false;
                    ...
                    swal('Error', 'No data loaded', 'error');
                }
            }
        });
    }
