//var baseurl = "http://docme.cloud:8888/Docme-UI/";
var baseurl = "http://10.10.4.241:8888/docme/Docme-UI/";
...
function page_content_onresize(){
    ...
    if($(window).width() > 1024){
        ...
        if($(".content-frame-body").height() < $(document).height()-162){
            $(".content-frame-body,.content-frame-right,.content-frame-left").height($(document).height()); 
            $(".page-container").height($(document).height());
        }else{
...
//        panel.append('<div class="panel-refresh-layer"><img src=' + baseurl + 'assets/img/loaders/default.gif"/></div>');
        panel.append('<div class="panel-refresh-layer"><i class="fa fa-refresh fa-spin fa-1x fa-fw" style="position: absolute;top: 50%;left: 50%;transform: translateX(-50%) translateY(-50%);"></i></div>');
