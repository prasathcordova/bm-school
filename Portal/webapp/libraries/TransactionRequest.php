...
class TransactionRequest
{
     ...
     * @return the $productId
     */
    public function getCustomerStudentId()
    {
     ...
     * @param string $productId
     */
    public function setCustomerStudentId($studentid)
    {
     ...
     * @return the $productId
     */
    public function getCustomerAdmissionNumber()
    {
        return $this->admn_no;
    }
     ...
     * @param string $productId
     */
    public function setCustomerAdmissionNumber($admn_no)
    {
    ...
    /**
     * @param string student fee data
     */
    public function setStudentFeeData($studentFeeData)
    {
        $this->studentFeeData = $studentFeeData;
    }
    ...
    private function getData()
    {
        ...
        $strReqst .= "&udf4=" . $this->getStudentFeeData();
        $strReqst .= "&udf9=" . $this->getCustomerStudentId();
        $strReqst .= "&udf6=" . $this->getCustomerAdmissionNumber();
