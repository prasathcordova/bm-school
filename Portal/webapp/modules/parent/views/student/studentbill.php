                ...
                <div class="col-md-3" style="text-align: left;">
                    ...
                    <div>
                        <?php if ($this->session->userdata('is_parent') == 1) { ?>
                            ...
                            <a class="back_button" style="color:#fff;margin-left:15px;display:none" href='<?php echo base_url() ?>payment-bookstore/<?php echo base64_encode($details_data[0]['Admn_No']) . "/" . $details_data[0]['Inst_ID'] ?>' title="Back"><i class="fa fa-angle-double-left"></i></a>
                        <?php } ?>
                    </div>
                </div>
...
<script>
    function select_items(id, barcode) {
        ...
        var ops_url = baseurl + 'bookstore/pack-details';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
