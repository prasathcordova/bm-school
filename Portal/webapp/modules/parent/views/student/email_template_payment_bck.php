                        ...
                        <td class="content-wrap">
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <?php if ($type == 1) { ?>
                                    <tr>
                                        <td class="content-block">
                                            Online Payment for your ward <b><?php echo $student_data['Student_Name'] ?></b> towards book store order is succesfull.Your order will be delivered shortly.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="content-block">
                                            Paid Amount : Rs.<?php echo $amt ?> /- only
                                        </td>
                                    </tr>
                                ...
                                <?php } else { ?>
                                    ...
                                    <tr>
                                        <td class="content-block">
                                            Online Payment for your ward <b><?php echo $student_data['Student_Name'] ?></b> is failed and your order is not placed.
                                        </td>
                                    </tr>
