        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="form-group form-float">
                    <div class="form-line">
                        <input type="text" class="form-control" name="mobile" id="mobile" autocomplete="off">
                        <label class="form-label">Optional Language</label>
                    </div>
                </div>
            </div>
            ...
            <div class="clearfix" ></div>
                 ...
                 <button type="button" class="btn btn-w-m btn-warning pull-right" style="background-color:#f68b1f!important"onclick="load_form_birth()">Continue</button>
...
//                startDate: '+0d'
    ...
    function load_form_birth() {
        var ops_url = baseurl + 'tempreg-formpage-birthdetails/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
