...
<div class="ibox"> 
    ...
    <div class="ibox-content" id="temp-view-reload" >
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                <div class="col-lg-5">
                    <div class="contact-box" style="height:310px;background-color: #006fba !important;color:white">
                        <a href="javascript:void(0)">
                            <div class="col-sm-8">
                                <strong style="color:white;"><?php // echo $sdetails_data[0]['Student_Name']       ?></strong>
                                <h2 style="color:white;">Course information
                                </h2>
                                <br>

                                </a>
                                <p style="color:white;font-size: large;"><i class="fa fa-language" style="color:white;"></i> KG and Montessori <?php // echo isset($sdetails_data[0]['Reg_No']) ? $sdetails_data[0]['Reg_No'] : "No Register Number"       ?></p>
                                <p style="color:white;font-size: large;"><i class="fa fa-book" style="color:white;"></i> Primary Section  </p>
                                <p style="color:white;font-size: large;"><i class="fa fa-id-badge" style="color:white;"></i> Grade 1 to 4 </p>
                                <p style="color:white;font-size: large;"><i class="fa fa-female" style="color:white;"></i> GRADE 6 to 12 (Girls) <?php // echo isset($details_data[0]['dem_date']) ? date('d-m-Y', strtotime($details_data[0]['dem_date'])) : date('10-m-Y')       ?></p>
                                <p style="color:white;font-size: large;"><i class="fa fa-graduation-cap" style="color:white;"></i> GRADE 6 to 12 (Boys) <?php // echo isset($details_data[0]['dem_date']) ? date('d-m-Y', strtotime($details_data[0]['dem_date'])) : date('10-m-Y')       ?></p>                                
                ...
                <div class="col-sm-3" style="padding-top: 48px;">
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" class="form-control" name="dob_date" id="dob_date" autocomplete="off">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12">
                                <div class="input-group m-b"style="width:235px;">
                                    <span class="input-group-addon" style="color:#f68b1f!important;font-size: 20px; ">OTP </span> 
                                    <input type="text" placeholder="Enter otp" class="form-control" name="payable_fee" id="payable_fee">
                                    <span class="input-group-btn"> <button style="background:#f68b1f!important;border-color: #f68b1f!important;" type="button" class="btn btn-primary">GO
                                        </button> </span>
                                </div>
                                <span class="text-muted small">
                                    *Mobile Number Validation is essential for completing a sucessfull Temporary Registration <?php echo $this->session->userdata('min_pay_amt'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="clearfix" ></div>
                <button type="button" class="btn btn-w-m btn-warning pull-right" style="background-color:#f68b1f!important"onclick="load_form()">Continue</button>
            </div>
        </div>
    </div>
</div>
