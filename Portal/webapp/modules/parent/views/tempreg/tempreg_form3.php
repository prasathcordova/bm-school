...
<div id="new-view-content" >
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <!--<div class="col-lg-5">-->
            <h1>Identification details of the Student</h1>   
            ...
            <div class="col-sm-4" style="padding-top: 48px;">
                <div class="form-group form-float">
                    <div class="form-line">
                        ...
                        <label class="form-label">Emirates Id/Aadhar Num</label>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <!--<div class="col-lg-5">-->
            <h1>Identification details of the Parent</h1>   
           <div class="col-sm-4" style="padding-top: 48px;">
                <div class="form-group form-float">
                    <div class="form-line">
                        <input type="text" class="form-control" name="penalty_amt" id="penalty_amt" autocomplete="off">
     ...
     <button type="button" class="btn btn-w-m btn-warning pull-right" style="background-color:#f68b1f!important"onclick="load_form_other();">Continue</button>
...
//                startDate: '+0d'
    ...
    function load_form_other() {
        var ops_url = baseurl + 'tempreg-formpage-otherdetails/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
