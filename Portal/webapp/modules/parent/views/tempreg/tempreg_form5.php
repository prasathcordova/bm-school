    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            ...
            <div class="clearfix" ></div>
                 ...
                 <button type="button" class="btn btn-w-m btn-warning pull-right" style="background-color:#f68b1f!important"onclick="load_form_sib()">Preview</button>
                 <button type="button" class="btn btn-w-m btn-warning pull-right" style="background-color:#f68b1f!important"onclick="load_form_sib()">Finish</button>
        ...
        <!--</div>-->
            ...
            <!--<div class="clearfix" ></div>-->
                 ...
                 <!--<button type="button" class="btn btn-w-m btn-warning pull-right" style="background-color:#f68b1f!important">Continue</button>-->
...
//                startDate: '+0d'
    ...
    function load_form_sib() {
        var ops_url = baseurl + 'tempreg-formpage-sibiling/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
