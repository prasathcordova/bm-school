...
if (null !== ($this->session->userdata('payment_status_message')) && $this->session->userdata('payment_status_message') == 1) {
    ?>
    <script type="text/javascript">activate_toast_login('Payement Success', 'Fee payment success. Please check payments tab for more information!!', 'success', 500);</script>    
    <?php
...
<div id="new-view-content" >
    <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-sm-4"style="padding-top: 48px;">
                <div class="form-group form-float">
                    <div class="form-line">
                        ...
                        <label class="form-label">Brothers Studying in this School</label>
            ...
            <div class="col-sm-4">
                <div class="form-group form-float">
                    <div class="form-line">
                        ...
                        <label class="form-label">Sisters Studying in this School</label>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <!--<div class="col-lg-5">-->
            <h1>Previous Academic Details</h1>   
            <div class="col-sm-4" style="padding-top: 48px;">
                <div class="form-group form-float">
                    <div class="form-line">
                        <input type="text" class="form-control" name="penalty_amt" id="penalty_amt" autocomplete="off">
     ...
     <button type="button" class="btn btn-w-m btn-warning pull-right" style="background-color:#f68b1f!important"onclick="load_form_commu();">Continue</button>
...
//                startDate: '+0d'
    ...
    function load_form_commu() {
        var ops_url = baseurl + 'tempreg-formpage-communication/';
        $.ajax({
            type: "POST",
            cache: false,
            async: false,
