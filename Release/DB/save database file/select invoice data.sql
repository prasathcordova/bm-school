...
BEGIN		
	...
	END
	  ...
	  Select vsb.*,vr.vehicleNum,vr.schoolNum,sc.serviceCenterName from [docme_transport].tbl_vehicle_service_booking vsb
	  ...
	  join [docme_transport].tbl_servicecenter sc
	   on vsb.serviceCenterId=sc.id
		 where vsb.instId=@inst_id  and vsb.isVehilceDelivered=0
